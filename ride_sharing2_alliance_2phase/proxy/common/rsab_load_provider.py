...
class RSABLoadProvider(object):
    ...
    def on_get(self, req, resp):
        ...
        # workload
        stmt = rsabutils.get_stmt_for_load(start_id, record_num, step)
        ...
        if prop_dict != {}:
            result = dejimautils.prop_request(prop_dict, global_xid, "frs", insert_delete=True)
        else:
            result = "Ack"
