...
BEGIN
    ...
    IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'dt_delta_action_flag') THEN
        ...
        END IF;
        DELETE FROM __tmp_delta_del_bt_for_dt WHERE ROW(ID,COL1,COL2,COL3,COL4,COL5,COL6,COL7,COL8,COL9,COL10,LINEAGE,CREATED_AT,UPDATED_AT)= NEW;
        INSERT INTO __tmp_delta_ins_bt_for_dt SELECT (NEW).*;
        ELSIF TG_OP = 'UPDATE' THEN
        IF (SELECT count(*) FILTER (WHERE j.value = jsonb 'null') FROM  jsonb_each(to_jsonb(NEW)) j) > 0 THEN
            RAISE check_violation USING MESSAGE = 'Invalid update: null value is not accepted';
        END IF;
        DELETE FROM __tmp_delta_ins_bt_for_dt WHERE ROW(ID,COL1,COL2,COL3,COL4,COL5,COL6,COL7,COL8,COL9,COL10,LINEAGE,CREATED_AT,UPDATED_AT) = OLD;
...
IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'bt_detect_update_on_dt_flag') THEN
    ...
    IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'dt_delta_action_flag') THEN
        ...
        SELECT array_agg(tbl) INTO detected_insertions FROM (SELECT __dummy__.COL0 AS ID, __dummy__.COL1 AS COL1, __dummy__.COL2 AS COL2, __dummy__.COL3 AS COL3, __dummy__.COL4 AS COL4, __dummy__.COL5 AS COL5, __dummy__.COL6 AS COL6, __dummy__.COL7 AS COL7, __dummy__.COL8 AS COL8, __dummy__.COL9 AS COL9, __dummy__.COL10 AS COL10, __dummy__.COL11 AS LINEAGE, __dummy__.COL12 AS CREATED_AT, __dummy__.COL13 AS UPDATED_AT FROM (SELECT part_ins_dt_a14_0.COL0 AS COL0, part_ins_dt_a14_0.COL1 AS COL1, part_ins_dt_a14_0.COL2 AS COL2, part_ins_dt_a14_0.COL3 AS COL3, part_ins_dt_a14_0.COL4 AS COL4, part_ins_dt_a14_0.COL5 AS COL5, part_ins_dt_a14_0.COL6 AS COL6, part_ins_dt_a14_0.COL7 AS COL7, part_ins_dt_a14_0.COL8 AS COL8, part_ins_dt_a14_0.COL9 AS COL9, part_ins_dt_a14_0.COL10 AS COL10, part_ins_dt_a14_0.COL11 AS COL11, part_ins_dt_a14_0.COL12 AS COL12, part_ins_dt_a14_0.COL13 AS COL13 FROM (SELECT p_0_a14_0.COL0 AS COL0, p_0_a14_0.COL1 AS COL1, p_0_a14_0.COL2 AS COL2, p_0_a14_0.COL3 AS COL3, p_0_a14_0.COL4 AS COL4, p_0_a14_0.COL5 AS COL5, p_0_a14_0.COL6 AS COL6, p_0_a14_0.COL7 AS COL7, p_0_a14_0.COL8 AS COL8, p_0_a14_0.COL9 AS COL9, p_0_a14_0.COL10 AS COL10, p_0_a14_0.COL11 AS COL11, p_0_a14_0.COL12 AS COL12, p_0_a14_0.COL13 AS COL13 FROM (SELECT __tmp_delta_ins_bt_for_dt_ar_a14_0.ID AS COL0, __tmp_delta_ins_bt_for_dt_ar_a14_0.COL1 AS COL1, __tmp_delta_ins_bt_for_dt_ar_a14_0.COL2 AS COL2, __tmp_delta_ins_bt_for_dt_ar_a14_0.COL3 AS COL3, __tmp_delta_ins_bt_for_dt_ar_a14_0.COL4 AS COL4, __tmp_delta_ins_bt_for_dt_ar_a14_0.COL5 AS COL5, __tmp_delta_ins_bt_for_dt_ar_a14_0.COL6 AS COL6, __tmp_delta_ins_bt_for_dt_ar_a14_0.COL7 AS COL7, __tmp_delta_ins_bt_for_dt_ar_a14_0.COL8 AS COL8, __tmp_delta_ins_bt_for_dt_ar_a14_0.COL9 AS COL9, __tmp_delta_ins_bt_for_dt_ar_a14_0.COL10 AS COL10, __tmp_delta_ins_bt_for_dt_ar_a14_0.LINEAGE AS COL11, __tmp_delta_ins_bt_for_dt_ar_a14_0.CREATED_AT AS COL12, __tmp_delta_ins_bt_for_dt_ar_a14_0.UPDATED_AT AS COL13 FROM __tmp_delta_ins_bt_for_dt_ar AS __tmp_delta_ins_bt_for_dt_ar_a14_0   ) AS p_0_a14_0   ) AS part_ins_dt_a14_0   ) AS __dummy__   ) AS tbl;
        ...
        WITH __tmp_delta_ins_bt_for_dt_ar as (SELECT * FROM unnest(array_delta_ins) as array_delta_ins_alias limit delta_ins_size),
        __tmp_delta_del_bt_for_dt_ar as (SELECT * FROM unnest(array_delta_del) as array_delta_del_alias limit delta_del_size)
        SELECT array_agg(tbl) INTO detected_deletions FROM (SELECT __dummy__.COL0 AS ID, __dummy__.COL1 AS COL1, __dummy__.COL2 AS COL2, __dummy__.COL3 AS COL3, __dummy__.COL4 AS COL4, __dummy__.COL5 AS COL5, __dummy__.COL6 AS COL6, __dummy__.COL7 AS COL7, __dummy__.COL8 AS COL8, __dummy__.COL9 AS COL9, __dummy__.COL10 AS COL10, __dummy__.COL11 AS LINEAGE, __dummy__.COL12 AS CREATED_AT, __dummy__.COL13 AS UPDATED_AT FROM (SELECT part_del_dt_a14_0.COL0 AS COL0, part_del_dt_a14_0.COL1 AS COL1, part_del_dt_a14_0.COL2 AS COL2, part_del_dt_a14_0.COL3 AS COL3, part_del_dt_a14_0.COL4 AS COL4, part_del_dt_a14_0.COL5 AS COL5, part_del_dt_a14_0.COL6 AS COL6, part_del_dt_a14_0.COL7 AS COL7, part_del_dt_a14_0.COL8 AS COL8, part_del_dt_a14_0.COL9 AS COL9, part_del_dt_a14_0.COL10 AS COL10, part_del_dt_a14_0.COL11 AS COL11, part_del_dt_a14_0.COL12 AS COL12, part_del_dt_a14_0.COL13 AS COL13 FROM (SELECT p_0_a14_0.COL0 AS COL0, p_0_a14_0.COL1 AS COL1, p_0_a14_0.COL2 AS COL2, p_0_a14_0.COL3 AS COL3, p_0_a14_0.COL4 AS COL4, p_0_a14_0.COL5 AS COL5, p_0_a14_0.COL6 AS COL6, p_0_a14_0.COL7 AS COL7, p_0_a14_0.COL8 AS COL8, p_0_a14_0.COL9 AS COL9, p_0_a14_0.COL10 AS COL10, p_0_a14_0.COL11 AS COL11, p_0_a14_0.COL12 AS COL12, p_0_a14_0.COL13 AS COL13 FROM (SELECT __tmp_delta_del_bt_for_dt_ar_a14_0.ID AS COL0, __tmp_delta_del_bt_for_dt_ar_a14_0.COL1 AS COL1, __tmp_delta_del_bt_for_dt_ar_a14_0.COL2 AS COL2, __tmp_delta_del_bt_for_dt_ar_a14_0.COL3 AS COL3, __tmp_delta_del_bt_for_dt_ar_a14_0.COL4 AS COL4, __tmp_delta_del_bt_for_dt_ar_a14_0.COL5 AS COL5, __tmp_delta_del_bt_for_dt_ar_a14_0.COL6 AS COL6, __tmp_delta_del_bt_for_dt_ar_a14_0.COL7 AS COL7, __tmp_delta_del_bt_for_dt_ar_a14_0.COL8 AS COL8, __tmp_delta_del_bt_for_dt_ar_a14_0.COL9 AS COL9, __tmp_delta_del_bt_for_dt_ar_a14_0.COL10 AS COL10, __tmp_delta_del_bt_for_dt_ar_a14_0.LINEAGE AS COL11, __tmp_delta_del_bt_for_dt_ar_a14_0.CREATED_AT AS COL12, __tmp_delta_del_bt_for_dt_ar_a14_0.UPDATED_AT AS COL13 FROM __tmp_delta_del_bt_for_dt_ar AS __tmp_delta_del_bt_for_dt_ar_a14_0   ) AS p_0_a14_0   ) AS part_del_dt_a14_0   ) AS __dummy__   ) AS tbl;
  ...
  BEGIN
    IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'dt_delta_action_flag') THEN
        ...
        select count(*) INTO delta_del_size FROM __tmp_delta_del_dt;
            ...
            FROM (SELECT delta_del_bt_a14_0.COL0 AS COL0, delta_del_bt_a14_0.COL1 AS COL1, delta_del_bt_a14_0.COL2 AS COL2, delta_del_bt_a14_0.COL3 AS COL3, delta_del_bt_a14_0.COL4 AS COL4, delta_del_bt_a14_0.COL5 AS COL5, delta_del_bt_a14_0.COL6 AS COL6, delta_del_bt_a14_0.COL7 AS COL7, delta_del_bt_a14_0.COL8 AS COL8, delta_del_bt_a14_0.COL9 AS COL9, delta_del_bt_a14_0.COL10 AS COL10, delta_del_bt_a14_0.COL11 AS COL11, delta_del_bt_a14_0.COL12 AS COL12, delta_del_bt_a14_0.COL13 AS COL13 FROM (SELECT p_0_a14_0.COL0 AS COL0, p_0_a14_0.COL1 AS COL1, p_0_a14_0.COL2 AS COL2, p_0_a14_0.COL3 AS COL3, p_0_a14_0.COL4 AS COL4, p_0_a14_0.COL5 AS COL5, p_0_a14_0.COL6 AS COL6, p_0_a14_0.COL7 AS COL7, p_0_a14_0.COL8 AS COL8, p_0_a14_0.COL9 AS COL9, p_0_a14_0.COL10 AS COL10, p_0_a14_0.COL11 AS COL11, p_0_a14_0.COL12 AS COL12, p_0_a14_0.COL13 AS COL13 FROM (SELECT bt_a14_1.ID AS COL0, bt_a14_1.COL1 AS COL1, bt_a14_1.COL2 AS COL2, bt_a14_1.COL3 AS COL3, bt_a14_1.COL4 AS COL4, bt_a14_1.COL5 AS COL5, bt_a14_1.COL6 AS COL6, bt_a14_1.COL7 AS COL7, bt_a14_1.COL8 AS COL8, bt_a14_1.COL9 AS COL9, bt_a14_1.COL10 AS COL10, bt_a14_1.LINEAGE AS COL11, bt_a14_1.CREATED_AT AS COL12, bt_a14_1.UPDATED_AT AS COL13 FROM __tmp_delta_del_dt_ar AS __tmp_delta_del_dt_ar_a14_0, public.bt AS bt_a14_1 WHERE bt_a14_1.COL7 = __tmp_delta_del_dt_ar_a14_0.COL7 AND bt_a14_1.COL5 = __tmp_delta_del_dt_ar_a14_0.COL5 AND bt_a14_1.COL2 = __tmp_delta_del_dt_ar_a14_0.COL2 AND bt_a14_1.COL6 = __tmp_delta_del_dt_ar_a14_0.COL6 AND bt_a14_1.COL10 = __tmp_delta_del_dt_ar_a14_0.COL10 AND bt_a14_1.CREATED_AT = __tmp_delta_del_dt_ar_a14_0.CREATED_AT AND bt_a14_1.COL1 = __tmp_delta_del_dt_ar_a14_0.COL1 AND bt_a14_1.COL3 = __tmp_delta_del_dt_ar_a14_0.COL3 AND bt_a14_1.COL8 = __tmp_delta_del_dt_ar_a14_0.COL8 AND bt_a14_1.LINEAGE = __tmp_delta_del_dt_ar_a14_0.LINEAGE AND bt_a14_1.COL9 = __tmp_delta_del_dt_ar_a14_0.COL9 AND bt_a14_1.ID = __tmp_delta_del_dt_ar_a14_0.ID AND bt_a14_1.COL4 = __tmp_delta_del_dt_ar_a14_0.COL4 AND bt_a14_1.UPDATED_AT = __tmp_delta_del_dt_ar_a14_0.UPDATED_AT  ) AS p_0_a14_0   ) AS delta_del_bt_a14_0   ) AS delta_del_bt_extra_alias) AS tbl;
            ...
            FROM (SELECT delta_ins_bt_a14_0.COL0 AS COL0, delta_ins_bt_a14_0.COL1 AS COL1, delta_ins_bt_a14_0.COL2 AS COL2, delta_ins_bt_a14_0.COL3 AS COL3, delta_ins_bt_a14_0.COL4 AS COL4, delta_ins_bt_a14_0.COL5 AS COL5, delta_ins_bt_a14_0.COL6 AS COL6, delta_ins_bt_a14_0.COL7 AS COL7, delta_ins_bt_a14_0.COL8 AS COL8, delta_ins_bt_a14_0.COL9 AS COL9, delta_ins_bt_a14_0.COL10 AS COL10, delta_ins_bt_a14_0.COL11 AS COL11, delta_ins_bt_a14_0.COL12 AS COL12, delta_ins_bt_a14_0.COL13 AS COL13 FROM (SELECT p_0_a14_0.COL0 AS COL0, p_0_a14_0.COL1 AS COL1, p_0_a14_0.COL2 AS COL2, p_0_a14_0.COL3 AS COL3, p_0_a14_0.COL4 AS COL4, p_0_a14_0.COL5 AS COL5, p_0_a14_0.COL6 AS COL6, p_0_a14_0.COL7 AS COL7, p_0_a14_0.COL8 AS COL8, p_0_a14_0.COL9 AS COL9, p_0_a14_0.COL10 AS COL10, p_0_a14_0.COL11 AS COL11, p_0_a14_0.COL12 AS COL12, p_0_a14_0.COL13 AS COL13 FROM (SELECT __tmp_delta_ins_dt_ar_a14_0.ID AS COL0, __tmp_delta_ins_dt_ar_a14_0.COL1 AS COL1, __tmp_delta_ins_dt_ar_a14_0.COL2 AS COL2, __tmp_delta_ins_dt_ar_a14_0.COL3 AS COL3, __tmp_delta_ins_dt_ar_a14_0.COL4 AS COL4, __tmp_delta_ins_dt_ar_a14_0.COL5 AS COL5, __tmp_delta_ins_dt_ar_a14_0.COL6 AS COL6, __tmp_delta_ins_dt_ar_a14_0.COL7 AS COL7, __tmp_delta_ins_dt_ar_a14_0.COL8 AS COL8, __tmp_delta_ins_dt_ar_a14_0.COL9 AS COL9, __tmp_delta_ins_dt_ar_a14_0.COL10 AS COL10, __tmp_delta_ins_dt_ar_a14_0.LINEAGE AS COL11, __tmp_delta_ins_dt_ar_a14_0.CREATED_AT AS COL12, __tmp_delta_ins_dt_ar_a14_0.UPDATED_AT AS COL13 FROM __tmp_delta_ins_dt_ar AS __tmp_delta_ins_dt_ar_a14_0 WHERE NOT EXISTS ( SELECT * FROM public.bt AS bt_a14 WHERE bt_a14.UPDATED_AT = __tmp_delta_ins_dt_ar_a14_0.UPDATED_AT AND bt_a14.CREATED_AT = __tmp_delta_ins_dt_ar_a14_0.CREATED_AT AND bt_a14.LINEAGE = __tmp_delta_ins_dt_ar_a14_0.LINEAGE AND bt_a14.COL10 = __tmp_delta_ins_dt_ar_a14_0.COL10 AND bt_a14.COL9 = __tmp_delta_ins_dt_ar_a14_0.COL9 AND bt_a14.COL8 = __tmp_delta_ins_dt_ar_a14_0.COL8 AND bt_a14.COL7 = __tmp_delta_ins_dt_ar_a14_0.COL7 AND bt_a14.COL6 = __tmp_delta_ins_dt_ar_a14_0.COL6 AND bt_a14.COL5 = __tmp_delta_ins_dt_ar_a14_0.COL5 AND bt_a14.COL4 = __tmp_delta_ins_dt_ar_a14_0.COL4 AND bt_a14.COL3 = __tmp_delta_ins_dt_ar_a14_0.COL3 AND bt_a14.COL2 = __tmp_delta_ins_dt_ar_a14_0.COL2 AND bt_a14.COL1 = __tmp_delta_ins_dt_ar_a14_0.COL1 AND bt_a14.ID = __tmp_delta_ins_dt_ar_a14_0.ID )  ) AS p_0_a14_0   ) AS delta_ins_bt_a14_0   ) AS delta_ins_bt_extra_alias) AS tbl; 
...
AS $$
  ...
  BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
      ...
      END IF;
      DELETE FROM __tmp_delta_del_dt WHERE ROW(ID,COL1,COL2,COL3,COL4,COL5,COL6,COL7,COL8,COL9,COL10,LINEAGE,CREATED_AT,UPDATED_AT) = NEW;
      INSERT INTO __tmp_delta_ins_dt SELECT (NEW).*;
    ELSIF TG_OP = 'UPDATE' THEN
      IF (SELECT count(*) FILTER (WHERE j.value = jsonb 'null') FROM  jsonb_each(to_jsonb(NEW)) j) > 0 THEN
        RAISE check_violation USING MESSAGE = 'Invalid update on view: view does not accept null value';
      END IF;
      DELETE FROM __tmp_delta_ins_dt WHERE ROW(ID,COL1,COL2,COL3,COL4,COL5,COL6,COL7,COL8,COL9,COL10,LINEAGE,CREATED_AT,UPDATED_AT) = OLD;
