...
WHERE mt_a16_0.COND6  <  <border> ) AS dnum_a16_0  ) AS __dummy__;
...
WHERE __tmp_delta_ins_mt_for_dnum_ar_a16_0.COND6  <  <border> ) AS p_0_a16_0  ) AS part_ins_dnum_a16_0  ) AS __dummy__) AS tbl;
...
WHERE __tmp_delta_del_mt_for_dnum_ar_a16_0.COND6  <  <border> ) AS p_0_a16_0  ) AS part_del_dnum_a16_0  ) AS __dummy__) AS tbl;
...
WHERE __tmp_delta_ins_dnum_ar_a16_0.COND6  <  <border> AND NOT EXISTS ( SELECT * 
