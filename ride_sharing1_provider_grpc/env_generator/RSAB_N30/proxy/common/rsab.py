...
from two_pl.do_rsabtx import doRSAB_2pl
import data_pb2
...
class RSAB(data_pb2_grpc.RSABServicer):
    ...
    def on_get(self, req, resp):
        ...
        res_dic["commit_num"] = commit_num
        res_dic["abort_num"] = abort_num
        res_dic["miss_num"] = miss_num
        res_dic["duration_time"] = bench_time-miss_time
        res_dic["throughput"] = commit_num/(bench_time-miss_time)
        res_dic["switch_cnt"] = switch_cnt
