...
SELECT __dummy__.COL0 AS V, __dummy__.COL1 AS L, __dummy__.COL2 AS D, __dummy__.COL3 AS R, __dummy__.COL4 AS LINEAGE FROM (SELECT d1_4_a5_0.COL0 AS COL0, d1_4_a5_0.COL1 AS COL1, d1_4_a5_0.COL2 AS COL2, d1_4_a5_0.COL3 AS COL3, d1_4_a5_0.COL4 AS COL4 FROM (SELECT bt_a6_0.V AS COL0, bt_a6_0.L AS COL1, bt_a6_0.D AS COL2, bt_a6_0.R AS COL3, bt_a6_0.LINEAGE AS COL4 FROM public.bt AS bt_a6_0 WHERE bt_a6_0.D1_4 = 'true'  ) AS d1_4_a5_0   ) AS __dummy__   ;
...
BEGIN
    ...
    IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'd1_4_delta_action_flag') THEN
        ...
        END IF;
        DELETE FROM __tmp_delta_del_bt_for_d1_4 WHERE ROW(V,L,D,R,D1_4,LINEAGE)= NEW;
        INSERT INTO __tmp_delta_ins_bt_for_d1_4 SELECT (NEW).*;
        ELSIF TG_OP = 'UPDATE' THEN
        IF (SELECT count(*) FILTER (WHERE j.value = jsonb 'null') FROM  jsonb_each(to_jsonb(NEW)) j) > 0 THEN
            RAISE check_violation USING MESSAGE = 'Invalid update: null value is not accepted';
        END IF;
        DELETE FROM __tmp_delta_ins_bt_for_d1_4 WHERE ROW(V,L,D,R,D1_4,LINEAGE) = OLD;
...
IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'bt_detect_update_on_d1_4_flag') THEN
    ...
    IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'd1_4_delta_action_flag') THEN
        ...
        SELECT array_agg(tbl) INTO detected_insertions FROM (SELECT __dummy__.COL0 AS V, __dummy__.COL1 AS L, __dummy__.COL2 AS D, __dummy__.COL3 AS R, __dummy__.COL4 AS LINEAGE FROM (SELECT part_ins_d1_4_a5_0.COL0 AS COL0, part_ins_d1_4_a5_0.COL1 AS COL1, part_ins_d1_4_a5_0.COL2 AS COL2, part_ins_d1_4_a5_0.COL3 AS COL3, part_ins_d1_4_a5_0.COL4 AS COL4 FROM (SELECT p_0_a5_0.COL0 AS COL0, p_0_a5_0.COL1 AS COL1, p_0_a5_0.COL2 AS COL2, p_0_a5_0.COL3 AS COL3, p_0_a5_0.COL4 AS COL4 FROM (SELECT __tmp_delta_ins_bt_for_d1_4_ar_a6_0.V AS COL0, __tmp_delta_ins_bt_for_d1_4_ar_a6_0.L AS COL1, __tmp_delta_ins_bt_for_d1_4_ar_a6_0.D AS COL2, __tmp_delta_ins_bt_for_d1_4_ar_a6_0.R AS COL3, __tmp_delta_ins_bt_for_d1_4_ar_a6_0.LINEAGE AS COL4 FROM __tmp_delta_ins_bt_for_d1_4_ar AS __tmp_delta_ins_bt_for_d1_4_ar_a6_0 WHERE __tmp_delta_ins_bt_for_d1_4_ar_a6_0.D1_4 = 'true' AND NOT EXISTS ( SELECT * FROM (SELECT __tmp_delta_ins_bt_for_d1_4_ar_a6_1.D AS COL0, __tmp_delta_ins_bt_for_d1_4_ar_a6_1.L AS COL1, __tmp_delta_ins_bt_for_d1_4_ar_a6_1.LINEAGE AS COL2, __tmp_delta_ins_bt_for_d1_4_ar_a6_1.R AS COL3, __tmp_delta_ins_bt_for_d1_4_ar_a6_1.V AS COL4 FROM __tmp_delta_del_bt_for_d1_4_ar AS __tmp_delta_del_bt_for_d1_4_ar_a6_0, __tmp_delta_ins_bt_for_d1_4_ar AS __tmp_delta_ins_bt_for_d1_4_ar_a6_1 WHERE __tmp_delta_ins_bt_for_d1_4_ar_a6_1.L = __tmp_delta_del_bt_for_d1_4_ar_a6_0.L AND __tmp_delta_ins_bt_for_d1_4_ar_a6_1.R = __tmp_delta_del_bt_for_d1_4_ar_a6_0.R AND __tmp_delta_ins_bt_for_d1_4_ar_a6_1.D1_4 = __tmp_delta_del_bt_for_d1_4_ar_a6_0.D1_4 AND __tmp_delta_ins_bt_for_d1_4_ar_a6_1.V = __tmp_delta_del_bt_for_d1_4_ar_a6_0.V AND __tmp_delta_ins_bt_for_d1_4_ar_a6_1.D = __tmp_delta_del_bt_for_d1_4_ar_a6_0.D AND __tmp_delta_ins_bt_for_d1_4_ar_a6_1.LINEAGE = __tmp_delta_del_bt_for_d1_4_ar_a6_0.LINEAGE AND __tmp_delta_ins_bt_for_d1_4_ar_a6_1.D1_4 = 'true' AND __tmp_delta_ins_bt_for_d1_4_ar_a6_1.D1_4 = 'true'   UNION SELECT __tmp_delta_ins_bt_for_d1_4_ar_a6_1.D AS COL0, __tmp_delta_ins_bt_for_d1_4_ar_a6_1.L AS COL1, __tmp_delta_ins_bt_for_d1_4_ar_a6_1.LINEAGE AS COL2, __tmp_delta_ins_bt_for_d1_4_ar_a6_1.R AS COL3, __tmp_delta_ins_bt_for_d1_4_ar_a6_1.V AS COL4 FROM public.bt AS bt_a6_0, __tmp_delta_ins_bt_for_d1_4_ar AS __tmp_delta_ins_bt_for_d1_4_ar_a6_1 WHERE __tmp_delta_ins_bt_for_d1_4_ar_a6_1.L = bt_a6_0.L AND __tmp_delta_ins_bt_for_d1_4_ar_a6_1.R = bt_a6_0.R AND __tmp_delta_ins_bt_for_d1_4_ar_a6_1.D1_4 = bt_a6_0.D1_4 AND __tmp_delta_ins_bt_for_d1_4_ar_a6_1.V = bt_a6_0.V AND __tmp_delta_ins_bt_for_d1_4_ar_a6_1.D = bt_a6_0.D AND __tmp_delta_ins_bt_for_d1_4_ar_a6_1.LINEAGE = bt_a6_0.LINEAGE AND __tmp_delta_ins_bt_for_d1_4_ar_a6_1.D1_4 = 'true' AND __tmp_delta_ins_bt_for_d1_4_ar_a6_1.D1_4 = 'true' AND NOT EXISTS ( SELECT * FROM (SELECT __tmp_delta_ins_bt_for_d1_4_ar_a6_0.D AS COL0, __tmp_delta_ins_bt_for_d1_4_ar_a6_0.L AS COL1, __tmp_delta_ins_bt_for_d1_4_ar_a6_0.LINEAGE AS COL2, __tmp_delta_ins_bt_for_d1_4_ar_a6_0.R AS COL3, __tmp_delta_ins_bt_for_d1_4_ar_a6_0.D1_4 AS COL4, __tmp_delta_ins_bt_for_d1_4_ar_a6_0.V AS COL5 FROM __tmp_delta_ins_bt_for_d1_4_ar AS __tmp_delta_ins_bt_for_d1_4_ar_a6_0 WHERE __tmp_delta_ins_bt_for_d1_4_ar_a6_0.D1_4 = 'true'  ) AS p_2_a6 WHERE p_2_a6.COL5 = __tmp_delta_ins_bt_for_d1_4_ar_a6_1.V AND p_2_a6.COL4 = __tmp_delta_ins_bt_for_d1_4_ar_a6_1.D1_4 AND p_2_a6.COL3 = __tmp_delta_ins_bt_for_d1_4_ar_a6_1.R AND p_2_a6.COL2 = __tmp_delta_ins_bt_for_d1_4_ar_a6_1.LINEAGE AND p_2_a6.COL1 = __tmp_delta_ins_bt_for_d1_4_ar_a6_1.L AND p_2_a6.COL0 = __tmp_delta_ins_bt_for_d1_4_ar_a6_1.D )  ) AS p_1_a5 WHERE p_1_a5.COL4 = __tmp_delta_ins_bt_for_d1_4_ar_a6_0.V AND p_1_a5.COL3 = __tmp_delta_ins_bt_for_d1_4_ar_a6_0.R AND p_1_a5.COL2 = __tmp_delta_ins_bt_for_d1_4_ar_a6_0.LINEAGE AND p_1_a5.COL1 = __tmp_delta_ins_bt_for_d1_4_ar_a6_0.L AND p_1_a5.COL0 = __tmp_delta_ins_bt_for_d1_4_ar_a6_0.D )  ) AS p_0_a5_0   ) AS part_ins_d1_4_a5_0   ) AS __dummy__   ) AS tbl;
        ...
        WITH __tmp_delta_ins_bt_for_d1_4_ar as (SELECT * FROM unnest(array_delta_ins) as array_delta_ins_alias limit delta_ins_size),
        __tmp_delta_del_bt_for_d1_4_ar as (SELECT * FROM unnest(array_delta_del) as array_delta_del_alias limit delta_del_size)
        SELECT array_agg(tbl) INTO detected_deletions FROM (SELECT __dummy__.COL0 AS V, __dummy__.COL1 AS L, __dummy__.COL2 AS D, __dummy__.COL3 AS R, __dummy__.COL4 AS LINEAGE FROM (SELECT part_del_d1_4_a5_0.COL0 AS COL0, part_del_d1_4_a5_0.COL1 AS COL1, part_del_d1_4_a5_0.COL2 AS COL2, part_del_d1_4_a5_0.COL3 AS COL3, part_del_d1_4_a5_0.COL4 AS COL4 FROM (SELECT p_0_a5_0.COL0 AS COL0, p_0_a5_0.COL1 AS COL1, p_0_a5_0.COL2 AS COL2, p_0_a5_0.COL3 AS COL3, p_0_a5_0.COL4 AS COL4 FROM (SELECT __tmp_delta_del_bt_for_d1_4_ar_a6_0.V AS COL0, __tmp_delta_del_bt_for_d1_4_ar_a6_0.L AS COL1, __tmp_delta_del_bt_for_d1_4_ar_a6_0.D AS COL2, __tmp_delta_del_bt_for_d1_4_ar_a6_0.R AS COL3, __tmp_delta_del_bt_for_d1_4_ar_a6_0.LINEAGE AS COL4 FROM __tmp_delta_del_bt_for_d1_4_ar AS __tmp_delta_del_bt_for_d1_4_ar_a6_0 WHERE __tmp_delta_del_bt_for_d1_4_ar_a6_0.D1_4 = 'true' AND NOT EXISTS ( SELECT * FROM (SELECT bt_a6_0.D AS COL0, bt_a6_0.L AS COL1, bt_a6_0.LINEAGE AS COL2, bt_a6_0.R AS COL3, bt_a6_0.V AS COL4 FROM public.bt AS bt_a6_0 WHERE bt_a6_0.D1_4 = 'true'  ) AS p_1_a5 WHERE p_1_a5.COL4 = __tmp_delta_del_bt_for_d1_4_ar_a6_0.V AND p_1_a5.COL3 = __tmp_delta_del_bt_for_d1_4_ar_a6_0.R AND p_1_a5.COL2 = __tmp_delta_del_bt_for_d1_4_ar_a6_0.LINEAGE AND p_1_a5.COL1 = __tmp_delta_del_bt_for_d1_4_ar_a6_0.L AND p_1_a5.COL0 = __tmp_delta_del_bt_for_d1_4_ar_a6_0.D )  ) AS p_0_a5_0   ) AS part_del_d1_4_a5_0   ) AS __dummy__   ) AS tbl;
  ...
  BEGIN
    IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'd1_4_delta_action_flag') THEN
        ...
        select count(*) INTO delta_del_size FROM __tmp_delta_del_d1_4;
            ...
            FROM (SELECT delta_del_bt_a6_0.COL0 AS COL0, delta_del_bt_a6_0.COL1 AS COL1, delta_del_bt_a6_0.COL2 AS COL2, delta_del_bt_a6_0.COL3 AS COL3, delta_del_bt_a6_0.COL4 AS COL4, delta_del_bt_a6_0.COL5 AS COL5 FROM (SELECT p_0_a6_0.COL0 AS COL0, p_0_a6_0.COL1 AS COL1, p_0_a6_0.COL2 AS COL2, p_0_a6_0.COL3 AS COL3, p_0_a6_0.COL4 AS COL4, p_0_a6_0.COL5 AS COL5 FROM (SELECT bt_a6_1.V AS COL0, bt_a6_1.L AS COL1, bt_a6_1.D AS COL2, bt_a6_1.R AS COL3, bt_a6_1.D1_4 AS COL4, bt_a6_1.LINEAGE AS COL5 FROM __tmp_delta_del_d1_4_ar AS __tmp_delta_del_d1_4_ar_a5_0, public.bt AS bt_a6_1 WHERE bt_a6_1.LINEAGE = __tmp_delta_del_d1_4_ar_a5_0.LINEAGE AND bt_a6_1.D = __tmp_delta_del_d1_4_ar_a5_0.D AND bt_a6_1.L = __tmp_delta_del_d1_4_ar_a5_0.L AND bt_a6_1.V = __tmp_delta_del_d1_4_ar_a5_0.V AND bt_a6_1.R = __tmp_delta_del_d1_4_ar_a5_0.R AND bt_a6_1.D1_4 = 'true'  ) AS p_0_a6_0   ) AS delta_del_bt_a6_0   ) AS delta_del_bt_extra_alias) AS tbl;


            WITH __tmp_delta_del_d1_4_ar AS (SELECT * FROM unnest(array_delta_del) as array_delta_del_alias limit delta_del_size),
            __tmp_delta_ins_d1_4_ar as (SELECT * FROM unnest(array_delta_ins) as array_delta_ins_alias limit delta_ins_size)
            SELECT array_agg(tbl) INTO array_delta_ins_bt FROM (SELECT (ROW(COL0,COL1,COL2,COL3,COL4,COL5) :: public.bt).*
            FROM (SELECT delta_ins_bt_a6_0.COL0 AS COL0, delta_ins_bt_a6_0.COL1 AS COL1, delta_ins_bt_a6_0.COL2 AS COL2, delta_ins_bt_a6_0.COL3 AS COL3, delta_ins_bt_a6_0.COL4 AS COL4, delta_ins_bt_a6_0.COL5 AS COL5 FROM (SELECT p_0_a6_0.COL0 AS COL0, p_0_a6_0.COL1 AS COL1, p_0_a6_0.COL2 AS COL2, p_0_a6_0.COL3 AS COL3, p_0_a6_0.COL4 AS COL4, p_0_a6_0.COL5 AS COL5 FROM (SELECT __tmp_delta_ins_d1_4_ar_a5_0.V AS COL0, __tmp_delta_ins_d1_4_ar_a5_0.L AS COL1, __tmp_delta_ins_d1_4_ar_a5_0.D AS COL2, __tmp_delta_ins_d1_4_ar_a5_0.R AS COL3, 'true' AS COL4, __tmp_delta_ins_d1_4_ar_a5_0.LINEAGE AS COL5 FROM __tmp_delta_ins_d1_4_ar AS __tmp_delta_ins_d1_4_ar_a5_0 WHERE NOT EXISTS ( SELECT * FROM public.bt AS bt_a6 WHERE bt_a6.LINEAGE = __tmp_delta_ins_d1_4_ar_a5_0.LINEAGE AND bt_a6.R = __tmp_delta_ins_d1_4_ar_a5_0.R AND bt_a6.D = __tmp_delta_ins_d1_4_ar_a5_0.D AND bt_a6.L = __tmp_delta_ins_d1_4_ar_a5_0.L AND bt_a6.V = __tmp_delta_ins_d1_4_ar_a5_0.V ) AND NOT EXISTS ( SELECT * FROM (SELECT bt_a6_1.V AS COL0, bt_a6_0.L AS COL1, bt_a6_0.D AS COL2, bt_a6_0.R AS COL3, 'true' AS COL4, bt_a6_0.LINEAGE AS COL5 FROM public.bt AS bt_a6_0, public.bt AS bt_a6_1 WHERE bt_a6_1.V = bt_a6_0.V AND bt_a6_0.D1_4 = 'true' AND NOT EXISTS ( SELECT * FROM public.bt AS bt_a6 WHERE bt_a6.LINEAGE = bt_a6_0.LINEAGE AND bt_a6.R = bt_a6_0.R AND bt_a6.D = bt_a6_0.D AND bt_a6.L = bt_a6_0.L AND bt_a6.V = bt_a6_1.V )  ) AS p_1_a6 WHERE p_1_a6.COL5 = __tmp_delta_ins_d1_4_ar_a5_0.LINEAGE AND p_1_a6.COL4 = 'true' AND p_1_a6.COL3 = __tmp_delta_ins_d1_4_ar_a5_0.R AND p_1_a6.COL2 = __tmp_delta_ins_d1_4_ar_a5_0.D AND p_1_a6.COL1 = __tmp_delta_ins_d1_4_ar_a5_0.L AND p_1_a6.COL0 = __tmp_delta_ins_d1_4_ar_a5_0.V ) AND NOT EXISTS ( SELECT * FROM public.bt AS bt_a6 WHERE bt_a6.V = __tmp_delta_ins_d1_4_ar_a5_0.V )   UNION SELECT bt_a6_1.V AS COL0, __tmp_delta_ins_d1_4_ar_a5_0.L AS COL1, __tmp_delta_ins_d1_4_ar_a5_0.D AS COL2, __tmp_delta_ins_d1_4_ar_a5_0.R AS COL3, 'true' AS COL4, __tmp_delta_ins_d1_4_ar_a5_0.LINEAGE AS COL5 FROM __tmp_delta_ins_d1_4_ar AS __tmp_delta_ins_d1_4_ar_a5_0, public.bt AS bt_a6_1 WHERE bt_a6_1.V = __tmp_delta_ins_d1_4_ar_a5_0.V AND NOT EXISTS ( SELECT * FROM public.bt AS bt_a6 WHERE bt_a6.LINEAGE = __tmp_delta_ins_d1_4_ar_a5_0.LINEAGE AND bt_a6.R = __tmp_delta_ins_d1_4_ar_a5_0.R AND bt_a6.D = __tmp_delta_ins_d1_4_ar_a5_0.D AND bt_a6.L = __tmp_delta_ins_d1_4_ar_a5_0.L AND bt_a6.V = bt_a6_1.V ) AND NOT EXISTS ( SELECT * FROM (SELECT bt_a6_1.V AS COL0, bt_a6_0.L AS COL1, bt_a6_0.D AS COL2, bt_a6_0.R AS COL3, 'true' AS COL4, bt_a6_0.LINEAGE AS COL5 FROM public.bt AS bt_a6_0, public.bt AS bt_a6_1 WHERE bt_a6_1.V = bt_a6_0.V AND bt_a6_0.D1_4 = 'true' AND NOT EXISTS ( SELECT * FROM public.bt AS bt_a6 WHERE bt_a6.LINEAGE = bt_a6_0.LINEAGE AND bt_a6.R = bt_a6_0.R AND bt_a6.D = bt_a6_0.D AND bt_a6.L = bt_a6_0.L AND bt_a6.V = bt_a6_1.V )  ) AS p_3_a6 WHERE p_3_a6.COL5 = __tmp_delta_ins_d1_4_ar_a5_0.LINEAGE AND p_3_a6.COL4 = 'true' AND p_3_a6.COL3 = __tmp_delta_ins_d1_4_ar_a5_0.R AND p_3_a6.COL2 = __tmp_delta_ins_d1_4_ar_a5_0.D AND p_3_a6.COL1 = __tmp_delta_ins_d1_4_ar_a5_0.L AND p_3_a6.COL0 = bt_a6_1.V ) AND NOT EXISTS ( SELECT * FROM (SELECT bt_a6_0.V AS COL0, bt_a6_0.L AS COL1, bt_a6_0.D AS COL2, bt_a6_0.R AS COL3, 'true' AS COL4, bt_a6_0.LINEAGE AS COL5 FROM public.bt AS bt_a6_0 WHERE bt_a6_0.D1_4 = 'true' AND NOT EXISTS ( SELECT * FROM public.bt AS bt_a6 WHERE bt_a6.LINEAGE = bt_a6_0.LINEAGE AND bt_a6.R = bt_a6_0.R AND bt_a6.D = bt_a6_0.D AND bt_a6.L = bt_a6_0.L AND bt_a6.V = bt_a6_0.V ) AND NOT EXISTS ( SELECT * FROM public.bt AS bt_a6 WHERE bt_a6.V = bt_a6_0.V )  ) AS p_2_a6 WHERE p_2_a6.COL5 = __tmp_delta_ins_d1_4_ar_a5_0.LINEAGE AND p_2_a6.COL4 = 'true' AND p_2_a6.COL3 = __tmp_delta_ins_d1_4_ar_a5_0.R AND p_2_a6.COL2 = __tmp_delta_ins_d1_4_ar_a5_0.D AND p_2_a6.COL1 = __tmp_delta_ins_d1_4_ar_a5_0.L AND p_2_a6.COL0 = bt_a6_1.V )  ) AS p_0_a6_0   ) AS delta_ins_bt_a6_0   ) AS delta_ins_bt_extra_alias) AS tbl; 


            IF array_delta_del_bt IS DISTINCT FROM NULL THEN
                FOREACH temprec_delta_del_bt IN array array_delta_del_bt  LOOP
                   DELETE FROM public.bt WHERE V = temprec_delta_del_bt.V AND L = temprec_delta_del_bt.L AND D = temprec_delta_del_bt.D AND R = temprec_delta_del_bt.R AND D1_4 = temprec_delta_del_bt.D1_4 AND LINEAGE = temprec_delta_del_bt.LINEAGE;
                END LOOP;
            END IF;
