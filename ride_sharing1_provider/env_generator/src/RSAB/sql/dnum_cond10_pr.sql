...
FROM (SELECT dnum_a21_0.COL0 AS COL0, dnum_a21_0.COL1 AS COL1, dnum_a21_0.COL2 AS COL2, dnum_a21_0.COL3 AS COL3, dnum_a21_0.COL4 AS COL4, dnum_a21_0.COL5 AS COL5, dnum_a21_0.COL6 AS COL6, dnum_a21_0.COL7 AS COL7, dnum_a21_0.COL8 AS COL8, dnum_a21_0.COL9 AS COL9, dnum_a21_0.COL10 AS COL10, dnum_a21_0.COL11 AS COL11, dnum_a21_0.COL12 AS COL12, dnum_a21_0.COL13 AS COL13, dnum_a21_0.COL14 AS COL14, dnum_a21_0.COL15 AS COL15, dnum_a21_0.COL16 AS COL16, dnum_a21_0.COL17 AS COL17, dnum_a21_0.COL18 AS COL18, dnum_a21_0.COL19 AS COL19, dnum_a21_0.COL20 AS COL20 
...
WHERE bt_a21_0.COND10  <  <border> ) AS dnum_a21_0  ) AS __dummy__;
...
BEGIN
    ...
    IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'dnum_delta_action_flag') THEN
        ...
        END IF;
        DELETE FROM __tmp_delta_del_bt_for_dnum WHERE ROW(V,L,D,R,T,AL1,AL2,AL3,AL4,AL5,LINEAGE,COND1,COND2,COND3,COND4,COND5,COND6,COND7,COND8,COND9,COND10) = NEW;
        INSERT INTO __tmp_delta_ins_bt_for_dnum SELECT (NEW).*; 
        ELSIF TG_OP = 'UPDATE' THEN
        IF (SELECT count(*) FILTER (WHERE j.value = jsonb 'null') FROM  jsonb_each(to_jsonb(NEW)) j) > 0 THEN 
            RAISE check_violation USING MESSAGE = 'Invalid update: null value is not accepted';
        END IF;
        DELETE FROM __tmp_delta_ins_bt_for_dnum WHERE ROW(V,L,D,R,T,AL1,AL2,AL3,AL4,AL5,LINEAGE,COND1,COND2,COND3,COND4,COND5,COND6,COND7,COND8,COND9,COND10) = OLD;
...
FROM (SELECT part_ins_dnum_a21_0.COL0 AS COL0, part_ins_dnum_a21_0.COL1 AS COL1, part_ins_dnum_a21_0.COL2 AS COL2, part_ins_dnum_a21_0.COL3 AS COL3, part_ins_dnum_a21_0.COL4 AS COL4, part_ins_dnum_a21_0.COL5 AS COL5, part_ins_dnum_a21_0.COL6 AS COL6, part_ins_dnum_a21_0.COL7 AS COL7, part_ins_dnum_a21_0.COL8 AS COL8, part_ins_dnum_a21_0.COL9 AS COL9, part_ins_dnum_a21_0.COL10 AS COL10, part_ins_dnum_a21_0.COL11 AS COL11, part_ins_dnum_a21_0.COL12 AS COL12, part_ins_dnum_a21_0.COL13 AS COL13, part_ins_dnum_a21_0.COL14 AS COL14, part_ins_dnum_a21_0.COL15 AS COL15, part_ins_dnum_a21_0.COL16 AS COL16, part_ins_dnum_a21_0.COL17 AS COL17, part_ins_dnum_a21_0.COL18 AS COL18, part_ins_dnum_a21_0.COL19 AS COL19, part_ins_dnum_a21_0.COL20 AS COL20 
...
FROM (SELECT __tmp_delta_ins_bt_for_dnum_ar_a21_0.V AS COL0, __tmp_delta_ins_bt_for_dnum_ar_a21_0.L AS COL1, __tmp_delta_ins_bt_for_dnum_ar_a21_0.D AS COL2, __tmp_delta_ins_bt_for_dnum_ar_a21_0.R AS COL3, __tmp_delta_ins_bt_for_dnum_ar_a21_0.T AS COL4, __tmp_delta_ins_bt_for_dnum_ar_a21_0.AL1 AS COL5, __tmp_delta_ins_bt_for_dnum_ar_a21_0.AL2 AS COL6, __tmp_delta_ins_bt_for_dnum_ar_a21_0.AL3 AS COL7, __tmp_delta_ins_bt_for_dnum_ar_a21_0.AL4 AS COL8, __tmp_delta_ins_bt_for_dnum_ar_a21_0.AL5 AS COL9, __tmp_delta_ins_bt_for_dnum_ar_a21_0.LINEAGE AS COL10, __tmp_delta_ins_bt_for_dnum_ar_a21_0.COND1 AS COL11, __tmp_delta_ins_bt_for_dnum_ar_a21_0.COND2 AS COL12, __tmp_delta_ins_bt_for_dnum_ar_a21_0.COND3 AS COL13, __tmp_delta_ins_bt_for_dnum_ar_a21_0.COND4 AS COL14, __tmp_delta_ins_bt_for_dnum_ar_a21_0.COND5 AS COL15, __tmp_delta_ins_bt_for_dnum_ar_a21_0.COND6 AS COL16, __tmp_delta_ins_bt_for_dnum_ar_a21_0.COND7 AS COL17, __tmp_delta_ins_bt_for_dnum_ar_a21_0.COND8 AS COL18, __tmp_delta_ins_bt_for_dnum_ar_a21_0.COND9 AS COL19, __tmp_delta_ins_bt_for_dnum_ar_a21_0.COND10 AS COL20 
FROM __tmp_delta_ins_bt_for_dnum_ar AS __tmp_delta_ins_bt_for_dnum_ar_a21_0 
WHERE __tmp_delta_ins_bt_for_dnum_ar_a21_0.COND10  <  <border> ) AS p_0_a21_0  ) AS part_ins_dnum_a21_0  ) AS __dummy__) AS tbl;
...
FROM (SELECT part_del_dnum_a21_0.COL0 AS COL0, part_del_dnum_a21_0.COL1 AS COL1, part_del_dnum_a21_0.COL2 AS COL2, part_del_dnum_a21_0.COL3 AS COL3, part_del_dnum_a21_0.COL4 AS COL4, part_del_dnum_a21_0.COL5 AS COL5, part_del_dnum_a21_0.COL6 AS COL6, part_del_dnum_a21_0.COL7 AS COL7, part_del_dnum_a21_0.COL8 AS COL8, part_del_dnum_a21_0.COL9 AS COL9, part_del_dnum_a21_0.COL10 AS COL10, part_del_dnum_a21_0.COL11 AS COL11, part_del_dnum_a21_0.COL12 AS COL12, part_del_dnum_a21_0.COL13 AS COL13, part_del_dnum_a21_0.COL14 AS COL14, part_del_dnum_a21_0.COL15 AS COL15, part_del_dnum_a21_0.COL16 AS COL16, part_del_dnum_a21_0.COL17 AS COL17, part_del_dnum_a21_0.COL18 AS COL18, part_del_dnum_a21_0.COL19 AS COL19, part_del_dnum_a21_0.COL20 AS COL20 
FROM (SELECT p_0_a21_0.COL0 AS COL0, p_0_a21_0.COL1 AS COL1, p_0_a21_0.COL2 AS COL2, p_0_a21_0.COL3 AS COL3, p_0_a21_0.COL4 AS COL4, p_0_a21_0.COL5 AS COL5, p_0_a21_0.COL6 AS COL6, p_0_a21_0.COL7 AS COL7, p_0_a21_0.COL8 AS COL8, p_0_a21_0.COL9 AS COL9, p_0_a21_0.COL10 AS COL10, p_0_a21_0.COL11 AS COL11, p_0_a21_0.COL12 AS COL12, p_0_a21_0.COL13 AS COL13, p_0_a21_0.COL14 AS COL14, p_0_a21_0.COL15 AS COL15, p_0_a21_0.COL16 AS COL16, p_0_a21_0.COL17 AS COL17, p_0_a21_0.COL18 AS COL18, p_0_a21_0.COL19 AS COL19, p_0_a21_0.COL20 AS COL20 
FROM (SELECT __tmp_delta_del_bt_for_dnum_ar_a21_0.V AS COL0, __tmp_delta_del_bt_for_dnum_ar_a21_0.L AS COL1, __tmp_delta_del_bt_for_dnum_ar_a21_0.D AS COL2, __tmp_delta_del_bt_for_dnum_ar_a21_0.R AS COL3, __tmp_delta_del_bt_for_dnum_ar_a21_0.T AS COL4, __tmp_delta_del_bt_for_dnum_ar_a21_0.AL1 AS COL5, __tmp_delta_del_bt_for_dnum_ar_a21_0.AL2 AS COL6, __tmp_delta_del_bt_for_dnum_ar_a21_0.AL3 AS COL7, __tmp_delta_del_bt_for_dnum_ar_a21_0.AL4 AS COL8, __tmp_delta_del_bt_for_dnum_ar_a21_0.AL5 AS COL9, __tmp_delta_del_bt_for_dnum_ar_a21_0.LINEAGE AS COL10, __tmp_delta_del_bt_for_dnum_ar_a21_0.COND1 AS COL11, __tmp_delta_del_bt_for_dnum_ar_a21_0.COND2 AS COL12, __tmp_delta_del_bt_for_dnum_ar_a21_0.COND3 AS COL13, __tmp_delta_del_bt_for_dnum_ar_a21_0.COND4 AS COL14, __tmp_delta_del_bt_for_dnum_ar_a21_0.COND5 AS COL15, __tmp_delta_del_bt_for_dnum_ar_a21_0.COND6 AS COL16, __tmp_delta_del_bt_for_dnum_ar_a21_0.COND7 AS COL17, __tmp_delta_del_bt_for_dnum_ar_a21_0.COND8 AS COL18, __tmp_delta_del_bt_for_dnum_ar_a21_0.COND9 AS COL19, __tmp_delta_del_bt_for_dnum_ar_a21_0.COND10 AS COL20 
FROM __tmp_delta_del_bt_for_dnum_ar AS __tmp_delta_del_bt_for_dnum_ar_a21_0 
WHERE __tmp_delta_del_bt_for_dnum_ar_a21_0.COND10  <  <border> ) AS p_0_a21_0  ) AS part_del_dnum_a21_0  ) AS __dummy__) AS tbl;
...
FROM __tmp_delta_del_dnum_ar AS __tmp_delta_del_dnum_ar_a21_0, public.bt AS bt_a21_1 
WHERE bt_a21_1.V = __tmp_delta_del_dnum_ar_a21_0.V AND bt_a21_1.L = __tmp_delta_del_dnum_ar_a21_0.L AND bt_a21_1.D = __tmp_delta_del_dnum_ar_a21_0.D AND bt_a21_1.R = __tmp_delta_del_dnum_ar_a21_0.R AND bt_a21_1.T = __tmp_delta_del_dnum_ar_a21_0.T AND bt_a21_1.AL1 = __tmp_delta_del_dnum_ar_a21_0.AL1 AND bt_a21_1.AL2 = __tmp_delta_del_dnum_ar_a21_0.AL2 AND bt_a21_1.AL3 = __tmp_delta_del_dnum_ar_a21_0.AL3 AND bt_a21_1.AL4 = __tmp_delta_del_dnum_ar_a21_0.AL4 AND bt_a21_1.AL5 = __tmp_delta_del_dnum_ar_a21_0.AL5 AND bt_a21_1.LINEAGE = __tmp_delta_del_dnum_ar_a21_0.LINEAGE AND bt_a21_1.COND1 = __tmp_delta_del_dnum_ar_a21_0.COND1 AND bt_a21_1.COND2 = __tmp_delta_del_dnum_ar_a21_0.COND2 AND bt_a21_1.COND3 = __tmp_delta_del_dnum_ar_a21_0.COND3 AND bt_a21_1.COND4 = __tmp_delta_del_dnum_ar_a21_0.COND4 AND bt_a21_1.COND5 = __tmp_delta_del_dnum_ar_a21_0.COND5 AND bt_a21_1.COND6 = __tmp_delta_del_dnum_ar_a21_0.COND6 AND bt_a21_1.COND7 = __tmp_delta_del_dnum_ar_a21_0.COND7 AND bt_a21_1.COND8 = __tmp_delta_del_dnum_ar_a21_0.COND8 AND bt_a21_1.COND9 = __tmp_delta_del_dnum_ar_a21_0.COND9 AND bt_a21_1.COND10 = __tmp_delta_del_dnum_ar_a21_0.COND10 AND bt_a21_1.COND10  <  <border> ) AS p_0_a21_0  ) AS delta_del_bt_a21_0  ) AS delta_del_bt_extra_alias) AS tbl;
...
FROM (SELECT p_0_a21_0.COL0 AS COL0, p_0_a21_0.COL1 AS COL1, p_0_a21_0.COL2 AS COL2, p_0_a21_0.COL3 AS COL3, p_0_a21_0.COL4 AS COL4, p_0_a21_0.COL5 AS COL5, p_0_a21_0.COL6 AS COL6, p_0_a21_0.COL7 AS COL7, p_0_a21_0.COL8 AS COL8, p_0_a21_0.COL9 AS COL9, p_0_a21_0.COL10 AS COL10, p_0_a21_0.COL11 AS COL11, p_0_a21_0.COL12 AS COL12, p_0_a21_0.COL13 AS COL13, p_0_a21_0.COL14 AS COL14, p_0_a21_0.COL15 AS COL15, p_0_a21_0.COL16 AS COL16, p_0_a21_0.COL17 AS COL17, p_0_a21_0.COL18 AS COL18, p_0_a21_0.COL19 AS COL19, p_0_a21_0.COL20 AS COL20 
FROM (SELECT __tmp_delta_ins_dnum_ar_a21_0.V AS COL0, __tmp_delta_ins_dnum_ar_a21_0.L AS COL1, __tmp_delta_ins_dnum_ar_a21_0.D AS COL2, __tmp_delta_ins_dnum_ar_a21_0.R AS COL3, __tmp_delta_ins_dnum_ar_a21_0.T AS COL4, __tmp_delta_ins_dnum_ar_a21_0.AL1 AS COL5, __tmp_delta_ins_dnum_ar_a21_0.AL2 AS COL6, __tmp_delta_ins_dnum_ar_a21_0.AL3 AS COL7, __tmp_delta_ins_dnum_ar_a21_0.AL4 AS COL8, __tmp_delta_ins_dnum_ar_a21_0.AL5 AS COL9, __tmp_delta_ins_dnum_ar_a21_0.LINEAGE AS COL10, __tmp_delta_ins_dnum_ar_a21_0.COND1 AS COL11, __tmp_delta_ins_dnum_ar_a21_0.COND2 AS COL12, __tmp_delta_ins_dnum_ar_a21_0.COND3 AS COL13, __tmp_delta_ins_dnum_ar_a21_0.COND4 AS COL14, __tmp_delta_ins_dnum_ar_a21_0.COND5 AS COL15, __tmp_delta_ins_dnum_ar_a21_0.COND6 AS COL16, __tmp_delta_ins_dnum_ar_a21_0.COND7 AS COL17, __tmp_delta_ins_dnum_ar_a21_0.COND8 AS COL18, __tmp_delta_ins_dnum_ar_a21_0.COND9 AS COL19, __tmp_delta_ins_dnum_ar_a21_0.COND10 AS COL20 
FROM __tmp_delta_ins_dnum_ar AS __tmp_delta_ins_dnum_ar_a21_0 
WHERE __tmp_delta_ins_dnum_ar_a21_0.COND10  <  <border> AND NOT EXISTS ( SELECT * 
FROM public.bt AS bt_a21 
WHERE bt_a21.V = __tmp_delta_ins_dnum_ar_a21_0.V AND bt_a21.L = __tmp_delta_ins_dnum_ar_a21_0.L AND bt_a21.D = __tmp_delta_ins_dnum_ar_a21_0.D AND bt_a21.R = __tmp_delta_ins_dnum_ar_a21_0.R AND bt_a21.T = __tmp_delta_ins_dnum_ar_a21_0.T AND bt_a21.AL1 = __tmp_delta_ins_dnum_ar_a21_0.AL1 AND bt_a21.AL2 = __tmp_delta_ins_dnum_ar_a21_0.AL2 AND bt_a21.AL3 = __tmp_delta_ins_dnum_ar_a21_0.AL3 AND bt_a21.AL4 = __tmp_delta_ins_dnum_ar_a21_0.AL4 AND bt_a21.AL5 = __tmp_delta_ins_dnum_ar_a21_0.AL5 AND bt_a21.LINEAGE = __tmp_delta_ins_dnum_ar_a21_0.LINEAGE AND bt_a21.COND1 = __tmp_delta_ins_dnum_ar_a21_0.COND1 AND bt_a21.COND2 = __tmp_delta_ins_dnum_ar_a21_0.COND2 AND bt_a21.COND3 = __tmp_delta_ins_dnum_ar_a21_0.COND3 AND bt_a21.COND4 = __tmp_delta_ins_dnum_ar_a21_0.COND4 AND bt_a21.COND5 = __tmp_delta_ins_dnum_ar_a21_0.COND5 AND bt_a21.COND6 = __tmp_delta_ins_dnum_ar_a21_0.COND6 AND bt_a21.COND7 = __tmp_delta_ins_dnum_ar_a21_0.COND7 AND bt_a21.COND8 = __tmp_delta_ins_dnum_ar_a21_0.COND8 AND bt_a21.COND9 = __tmp_delta_ins_dnum_ar_a21_0.COND9 AND bt_a21.COND10 = __tmp_delta_ins_dnum_ar_a21_0.COND10 ) ) AS p_0_a21_0  ) AS delta_ins_bt_a21_0  ) AS delta_ins_bt_extra_alias) AS tbl; 
...
AS $$
  ...
  BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
      ...
      END IF;
      DELETE FROM __tmp_delta_del_dnum WHERE ROW(V,L,D,R,T,AL1,AL2,AL3,AL4,AL5,LINEAGE,COND1,COND2,COND3,COND4,COND5,COND6,COND7,COND8,COND9,COND10) = NEW;
      INSERT INTO __tmp_delta_ins_dnum SELECT (NEW).*; 
    ELSIF TG_OP = 'UPDATE' THEN
      IF (SELECT count(*) FILTER (WHERE j.value = jsonb 'null') FROM  jsonb_each(to_jsonb(NEW)) j) > 0 THEN 
        RAISE check_violation USING MESSAGE = 'Invalid update on view: view does not accept null value';
      END IF;
      DELETE FROM __tmp_delta_ins_dnum WHERE ROW(V,L,D,R,T,AL1,AL2,AL3,AL4,AL5,LINEAGE,COND1,COND2,COND3,COND4,COND5,COND6,COND7,COND8,COND9,COND10) = OLD;
