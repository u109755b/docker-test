...
SELECT __dummy__.COL0 AS V, __dummy__.COL1 AS L, __dummy__.COL2 AS D, __dummy__.COL3 AS R, __dummy__.COL4 AS LINEAGE FROM (SELECT d1_5_a5_0.COL0 AS COL0, d1_5_a5_0.COL1 AS COL1, d1_5_a5_0.COL2 AS COL2, d1_5_a5_0.COL3 AS COL3, d1_5_a5_0.COL4 AS COL4 FROM (SELECT bt_a6_0.V AS COL0, bt_a6_0.L AS COL1, bt_a6_0.D AS COL2, bt_a6_0.R AS COL3, bt_a6_0.LINEAGE AS COL4 FROM public.bt AS bt_a6_0 WHERE bt_a6_0.D1_5 = 'true'  ) AS d1_5_a5_0   ) AS __dummy__   ;
...
BEGIN
    ...
    IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'd1_5_delta_action_flag') THEN
        ...
        END IF;
        DELETE FROM __tmp_delta_del_bt_for_d1_5 WHERE ROW(V,L,D,R,D1_5,LINEAGE)= NEW;
        INSERT INTO __tmp_delta_ins_bt_for_d1_5 SELECT (NEW).*;
        ELSIF TG_OP = 'UPDATE' THEN
        IF (SELECT count(*) FILTER (WHERE j.value = jsonb 'null') FROM  jsonb_each(to_jsonb(NEW)) j) > 0 THEN
            RAISE check_violation USING MESSAGE = 'Invalid update: null value is not accepted';
        END IF;
        DELETE FROM __tmp_delta_ins_bt_for_d1_5 WHERE ROW(V,L,D,R,D1_5,LINEAGE) = OLD;
...
IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'bt_detect_update_on_d1_5_flag') THEN
    ...
    IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'd1_5_delta_action_flag') THEN
        ...
        SELECT array_agg(tbl) INTO detected_insertions FROM (SELECT __dummy__.COL0 AS V, __dummy__.COL1 AS L, __dummy__.COL2 AS D, __dummy__.COL3 AS R, __dummy__.COL4 AS LINEAGE FROM (SELECT part_ins_d1_5_a5_0.COL0 AS COL0, part_ins_d1_5_a5_0.COL1 AS COL1, part_ins_d1_5_a5_0.COL2 AS COL2, part_ins_d1_5_a5_0.COL3 AS COL3, part_ins_d1_5_a5_0.COL4 AS COL4 FROM (SELECT p_0_a5_0.COL0 AS COL0, p_0_a5_0.COL1 AS COL1, p_0_a5_0.COL2 AS COL2, p_0_a5_0.COL3 AS COL3, p_0_a5_0.COL4 AS COL4 FROM (SELECT __tmp_delta_ins_bt_for_d1_5_ar_a6_0.V AS COL0, __tmp_delta_ins_bt_for_d1_5_ar_a6_0.L AS COL1, __tmp_delta_ins_bt_for_d1_5_ar_a6_0.D AS COL2, __tmp_delta_ins_bt_for_d1_5_ar_a6_0.R AS COL3, __tmp_delta_ins_bt_for_d1_5_ar_a6_0.LINEAGE AS COL4 FROM __tmp_delta_ins_bt_for_d1_5_ar AS __tmp_delta_ins_bt_for_d1_5_ar_a6_0 WHERE __tmp_delta_ins_bt_for_d1_5_ar_a6_0.D1_5 = 'true' AND NOT EXISTS ( SELECT * FROM (SELECT __tmp_delta_ins_bt_for_d1_5_ar_a6_1.D AS COL0, __tmp_delta_ins_bt_for_d1_5_ar_a6_1.L AS COL1, __tmp_delta_ins_bt_for_d1_5_ar_a6_1.LINEAGE AS COL2, __tmp_delta_ins_bt_for_d1_5_ar_a6_1.R AS COL3, __tmp_delta_ins_bt_for_d1_5_ar_a6_1.V AS COL4 FROM __tmp_delta_del_bt_for_d1_5_ar AS __tmp_delta_del_bt_for_d1_5_ar_a6_0, __tmp_delta_ins_bt_for_d1_5_ar AS __tmp_delta_ins_bt_for_d1_5_ar_a6_1 WHERE __tmp_delta_ins_bt_for_d1_5_ar_a6_1.L = __tmp_delta_del_bt_for_d1_5_ar_a6_0.L AND __tmp_delta_ins_bt_for_d1_5_ar_a6_1.R = __tmp_delta_del_bt_for_d1_5_ar_a6_0.R AND __tmp_delta_ins_bt_for_d1_5_ar_a6_1.D1_5 = __tmp_delta_del_bt_for_d1_5_ar_a6_0.D1_5 AND __tmp_delta_ins_bt_for_d1_5_ar_a6_1.V = __tmp_delta_del_bt_for_d1_5_ar_a6_0.V AND __tmp_delta_ins_bt_for_d1_5_ar_a6_1.D = __tmp_delta_del_bt_for_d1_5_ar_a6_0.D AND __tmp_delta_ins_bt_for_d1_5_ar_a6_1.LINEAGE = __tmp_delta_del_bt_for_d1_5_ar_a6_0.LINEAGE AND __tmp_delta_ins_bt_for_d1_5_ar_a6_1.D1_5 = 'true' AND __tmp_delta_ins_bt_for_d1_5_ar_a6_1.D1_5 = 'true'   UNION SELECT __tmp_delta_ins_bt_for_d1_5_ar_a6_1.D AS COL0, __tmp_delta_ins_bt_for_d1_5_ar_a6_1.L AS COL1, __tmp_delta_ins_bt_for_d1_5_ar_a6_1.LINEAGE AS COL2, __tmp_delta_ins_bt_for_d1_5_ar_a6_1.R AS COL3, __tmp_delta_ins_bt_for_d1_5_ar_a6_1.V AS COL4 FROM public.bt AS bt_a6_0, __tmp_delta_ins_bt_for_d1_5_ar AS __tmp_delta_ins_bt_for_d1_5_ar_a6_1 WHERE __tmp_delta_ins_bt_for_d1_5_ar_a6_1.L = bt_a6_0.L AND __tmp_delta_ins_bt_for_d1_5_ar_a6_1.R = bt_a6_0.R AND __tmp_delta_ins_bt_for_d1_5_ar_a6_1.D1_5 = bt_a6_0.D1_5 AND __tmp_delta_ins_bt_for_d1_5_ar_a6_1.V = bt_a6_0.V AND __tmp_delta_ins_bt_for_d1_5_ar_a6_1.D = bt_a6_0.D AND __tmp_delta_ins_bt_for_d1_5_ar_a6_1.LINEAGE = bt_a6_0.LINEAGE AND __tmp_delta_ins_bt_for_d1_5_ar_a6_1.D1_5 = 'true' AND __tmp_delta_ins_bt_for_d1_5_ar_a6_1.D1_5 = 'true' AND NOT EXISTS ( SELECT * FROM (SELECT __tmp_delta_ins_bt_for_d1_5_ar_a6_0.D AS COL0, __tmp_delta_ins_bt_for_d1_5_ar_a6_0.L AS COL1, __tmp_delta_ins_bt_for_d1_5_ar_a6_0.LINEAGE AS COL2, __tmp_delta_ins_bt_for_d1_5_ar_a6_0.R AS COL3, __tmp_delta_ins_bt_for_d1_5_ar_a6_0.D1_5 AS COL4, __tmp_delta_ins_bt_for_d1_5_ar_a6_0.V AS COL5 FROM __tmp_delta_ins_bt_for_d1_5_ar AS __tmp_delta_ins_bt_for_d1_5_ar_a6_0 WHERE __tmp_delta_ins_bt_for_d1_5_ar_a6_0.D1_5 = 'true'  ) AS p_2_a6 WHERE p_2_a6.COL5 = __tmp_delta_ins_bt_for_d1_5_ar_a6_1.V AND p_2_a6.COL4 = __tmp_delta_ins_bt_for_d1_5_ar_a6_1.D1_5 AND p_2_a6.COL3 = __tmp_delta_ins_bt_for_d1_5_ar_a6_1.R AND p_2_a6.COL2 = __tmp_delta_ins_bt_for_d1_5_ar_a6_1.LINEAGE AND p_2_a6.COL1 = __tmp_delta_ins_bt_for_d1_5_ar_a6_1.L AND p_2_a6.COL0 = __tmp_delta_ins_bt_for_d1_5_ar_a6_1.D )  ) AS p_1_a5 WHERE p_1_a5.COL4 = __tmp_delta_ins_bt_for_d1_5_ar_a6_0.V AND p_1_a5.COL3 = __tmp_delta_ins_bt_for_d1_5_ar_a6_0.R AND p_1_a5.COL2 = __tmp_delta_ins_bt_for_d1_5_ar_a6_0.LINEAGE AND p_1_a5.COL1 = __tmp_delta_ins_bt_for_d1_5_ar_a6_0.L AND p_1_a5.COL0 = __tmp_delta_ins_bt_for_d1_5_ar_a6_0.D )  ) AS p_0_a5_0   ) AS part_ins_d1_5_a5_0   ) AS __dummy__   ) AS tbl;
