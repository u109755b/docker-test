...
FROM (SELECT bt_a16_0.V AS COL0, bt_a16_0.L AS COL1, bt_a16_0.D AS COL2, bt_a16_0.R AS COL3, bt_a16_0.P AS COL4, bt_a16_0.LINEAGE AS COL5, bt_a16_0.COND1 AS COL6, bt_a16_0.COND2 AS COL7, bt_a16_0.COND3 AS COL8, bt_a16_0.COND4 AS COL9, bt_a16_0.COND5 AS COL10, bt_a16_0.COND6 AS COL11, bt_a16_0.COND7 AS COL12, bt_a16_0.COND8 AS COL13, bt_a16_0.COND9 AS COL14, bt_a16_0.COND10 AS COL15 
FROM public.bt AS bt_a16_0 
WHERE bt_a16_0.COND1  <  <border> ) AS dnum_a16_0  ) AS __dummy__;
...
BEGIN
    ...
    IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'dnum_delta_action_flag') THEN
        ...
        END IF;
        DELETE FROM __tmp_delta_del_bt_for_dnum WHERE ROW(V,L,D,R,P,LINEAGE,COND1,COND2,COND3,COND4,COND5,COND6,COND7,COND8,COND9,COND10) = NEW;
        INSERT INTO __tmp_delta_ins_bt_for_dnum SELECT (NEW).*; 
        ELSIF TG_OP = 'UPDATE' THEN
        IF (SELECT count(*) FILTER (WHERE j.value = jsonb 'null') FROM  jsonb_each(to_jsonb(NEW)) j) > 0 THEN 
            RAISE check_violation USING MESSAGE = 'Invalid update: null value is not accepted';
        END IF;
        DELETE FROM __tmp_delta_ins_bt_for_dnum WHERE ROW(V,L,D,R,P,LINEAGE,COND1,COND2,COND3,COND4,COND5,COND6,COND7,COND8,COND9,COND10) = OLD;
...
FROM (SELECT __tmp_delta_ins_bt_for_dnum_ar_a16_0.V AS COL0, __tmp_delta_ins_bt_for_dnum_ar_a16_0.L AS COL1, __tmp_delta_ins_bt_for_dnum_ar_a16_0.D AS COL2, __tmp_delta_ins_bt_for_dnum_ar_a16_0.R AS COL3, __tmp_delta_ins_bt_for_dnum_ar_a16_0.P AS COL4, __tmp_delta_ins_bt_for_dnum_ar_a16_0.LINEAGE AS COL5, __tmp_delta_ins_bt_for_dnum_ar_a16_0.COND1 AS COL6, __tmp_delta_ins_bt_for_dnum_ar_a16_0.COND2 AS COL7, __tmp_delta_ins_bt_for_dnum_ar_a16_0.COND3 AS COL8, __tmp_delta_ins_bt_for_dnum_ar_a16_0.COND4 AS COL9, __tmp_delta_ins_bt_for_dnum_ar_a16_0.COND5 AS COL10, __tmp_delta_ins_bt_for_dnum_ar_a16_0.COND6 AS COL11, __tmp_delta_ins_bt_for_dnum_ar_a16_0.COND7 AS COL12, __tmp_delta_ins_bt_for_dnum_ar_a16_0.COND8 AS COL13, __tmp_delta_ins_bt_for_dnum_ar_a16_0.COND9 AS COL14, __tmp_delta_ins_bt_for_dnum_ar_a16_0.COND10 AS COL15 
FROM __tmp_delta_ins_bt_for_dnum_ar AS __tmp_delta_ins_bt_for_dnum_ar_a16_0 
WHERE __tmp_delta_ins_bt_for_dnum_ar_a16_0.COND1  <  <border> ) AS p_0_a16_0  ) AS part_ins_dnum_a16_0  ) AS __dummy__) AS tbl;
...
FROM (SELECT p_0_a16_0.COL0 AS COL0, p_0_a16_0.COL1 AS COL1, p_0_a16_0.COL2 AS COL2, p_0_a16_0.COL3 AS COL3, p_0_a16_0.COL4 AS COL4, p_0_a16_0.COL5 AS COL5, p_0_a16_0.COL6 AS COL6, p_0_a16_0.COL7 AS COL7, p_0_a16_0.COL8 AS COL8, p_0_a16_0.COL9 AS COL9, p_0_a16_0.COL10 AS COL10, p_0_a16_0.COL11 AS COL11, p_0_a16_0.COL12 AS COL12, p_0_a16_0.COL13 AS COL13, p_0_a16_0.COL14 AS COL14, p_0_a16_0.COL15 AS COL15 
FROM (SELECT __tmp_delta_del_bt_for_dnum_ar_a16_0.V AS COL0, __tmp_delta_del_bt_for_dnum_ar_a16_0.L AS COL1, __tmp_delta_del_bt_for_dnum_ar_a16_0.D AS COL2, __tmp_delta_del_bt_for_dnum_ar_a16_0.R AS COL3, __tmp_delta_del_bt_for_dnum_ar_a16_0.P AS COL4, __tmp_delta_del_bt_for_dnum_ar_a16_0.LINEAGE AS COL5, __tmp_delta_del_bt_for_dnum_ar_a16_0.COND1 AS COL6, __tmp_delta_del_bt_for_dnum_ar_a16_0.COND2 AS COL7, __tmp_delta_del_bt_for_dnum_ar_a16_0.COND3 AS COL8, __tmp_delta_del_bt_for_dnum_ar_a16_0.COND4 AS COL9, __tmp_delta_del_bt_for_dnum_ar_a16_0.COND5 AS COL10, __tmp_delta_del_bt_for_dnum_ar_a16_0.COND6 AS COL11, __tmp_delta_del_bt_for_dnum_ar_a16_0.COND7 AS COL12, __tmp_delta_del_bt_for_dnum_ar_a16_0.COND8 AS COL13, __tmp_delta_del_bt_for_dnum_ar_a16_0.COND9 AS COL14, __tmp_delta_del_bt_for_dnum_ar_a16_0.COND10 AS COL15 
FROM __tmp_delta_del_bt_for_dnum_ar AS __tmp_delta_del_bt_for_dnum_ar_a16_0 
WHERE __tmp_delta_del_bt_for_dnum_ar_a16_0.COND1  <  <border> ) AS p_0_a16_0  ) AS part_del_dnum_a16_0  ) AS __dummy__) AS tbl;
  ...
  BEGIN
    IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'dnum_delta_action_flag') THEN
        ...
        select count(*) INTO delta_del_size FROM __tmp_delta_del_dnum;
            ...
            SELECT array_agg(tbl) INTO array_delta_del_bt FROM (SELECT (ROW(COL0,COL1,COL2,COL3,COL4,COL5,COL6,COL7,COL8,COL9,COL10,COL11,COL12,COL13,COL14,COL15) :: public.bt).* 
            FROM (SELECT delta_del_bt_a16_0.COL0 AS COL0, delta_del_bt_a16_0.COL1 AS COL1, delta_del_bt_a16_0.COL2 AS COL2, delta_del_bt_a16_0.COL3 AS COL3, delta_del_bt_a16_0.COL4 AS COL4, delta_del_bt_a16_0.COL5 AS COL5, delta_del_bt_a16_0.COL6 AS COL6, delta_del_bt_a16_0.COL7 AS COL7, delta_del_bt_a16_0.COL8 AS COL8, delta_del_bt_a16_0.COL9 AS COL9, delta_del_bt_a16_0.COL10 AS COL10, delta_del_bt_a16_0.COL11 AS COL11, delta_del_bt_a16_0.COL12 AS COL12, delta_del_bt_a16_0.COL13 AS COL13, delta_del_bt_a16_0.COL14 AS COL14, delta_del_bt_a16_0.COL15 AS COL15 
FROM (SELECT p_0_a16_0.COL0 AS COL0, p_0_a16_0.COL1 AS COL1, p_0_a16_0.COL2 AS COL2, p_0_a16_0.COL3 AS COL3, p_0_a16_0.COL4 AS COL4, p_0_a16_0.COL5 AS COL5, p_0_a16_0.COL6 AS COL6, p_0_a16_0.COL7 AS COL7, p_0_a16_0.COL8 AS COL8, p_0_a16_0.COL9 AS COL9, p_0_a16_0.COL10 AS COL10, p_0_a16_0.COL11 AS COL11, p_0_a16_0.COL12 AS COL12, p_0_a16_0.COL13 AS COL13, p_0_a16_0.COL14 AS COL14, p_0_a16_0.COL15 AS COL15 
FROM (SELECT bt_a16_1.V AS COL0, bt_a16_1.L AS COL1, bt_a16_1.D AS COL2, bt_a16_1.R AS COL3, bt_a16_1.P AS COL4, bt_a16_1.LINEAGE AS COL5, bt_a16_1.COND1 AS COL6, bt_a16_1.COND2 AS COL7, bt_a16_1.COND3 AS COL8, bt_a16_1.COND4 AS COL9, bt_a16_1.COND5 AS COL10, bt_a16_1.COND6 AS COL11, bt_a16_1.COND7 AS COL12, bt_a16_1.COND8 AS COL13, bt_a16_1.COND9 AS COL14, bt_a16_1.COND10 AS COL15 
FROM __tmp_delta_del_dnum_ar AS __tmp_delta_del_dnum_ar_a16_0, public.bt AS bt_a16_1 
WHERE bt_a16_1.V = __tmp_delta_del_dnum_ar_a16_0.V AND bt_a16_1.L = __tmp_delta_del_dnum_ar_a16_0.L AND bt_a16_1.D = __tmp_delta_del_dnum_ar_a16_0.D AND bt_a16_1.R = __tmp_delta_del_dnum_ar_a16_0.R AND bt_a16_1.P = __tmp_delta_del_dnum_ar_a16_0.P AND bt_a16_1.LINEAGE = __tmp_delta_del_dnum_ar_a16_0.LINEAGE AND bt_a16_1.COND1 = __tmp_delta_del_dnum_ar_a16_0.COND1 AND bt_a16_1.COND2 = __tmp_delta_del_dnum_ar_a16_0.COND2 AND bt_a16_1.COND3 = __tmp_delta_del_dnum_ar_a16_0.COND3 AND bt_a16_1.COND4 = __tmp_delta_del_dnum_ar_a16_0.COND4 AND bt_a16_1.COND5 = __tmp_delta_del_dnum_ar_a16_0.COND5 AND bt_a16_1.COND6 = __tmp_delta_del_dnum_ar_a16_0.COND6 AND bt_a16_1.COND7 = __tmp_delta_del_dnum_ar_a16_0.COND7 AND bt_a16_1.COND8 = __tmp_delta_del_dnum_ar_a16_0.COND8 AND bt_a16_1.COND9 = __tmp_delta_del_dnum_ar_a16_0.COND9 AND bt_a16_1.COND10 = __tmp_delta_del_dnum_ar_a16_0.COND10 AND bt_a16_1.COND1  <  <border> ) AS p_0_a16_0  ) AS delta_del_bt_a16_0  ) AS delta_del_bt_extra_alias) AS tbl;


            WITH __tmp_delta_del_dnum_ar AS (SELECT * FROM unnest(array_delta_del) as array_delta_del_alias limit delta_del_size),
            __tmp_delta_ins_dnum_ar as (SELECT * FROM unnest(array_delta_ins) as array_delta_ins_alias limit delta_ins_size)
            SELECT array_agg(tbl) INTO array_delta_ins_bt FROM (SELECT (ROW(COL0,COL1,COL2,COL3,COL4,COL5,COL6,COL7,COL8,COL9,COL10,COL11,COL12,COL13,COL14,COL15) :: public.bt).* 
            FROM (SELECT delta_ins_bt_a16_0.COL0 AS COL0, delta_ins_bt_a16_0.COL1 AS COL1, delta_ins_bt_a16_0.COL2 AS COL2, delta_ins_bt_a16_0.COL3 AS COL3, delta_ins_bt_a16_0.COL4 AS COL4, delta_ins_bt_a16_0.COL5 AS COL5, delta_ins_bt_a16_0.COL6 AS COL6, delta_ins_bt_a16_0.COL7 AS COL7, delta_ins_bt_a16_0.COL8 AS COL8, delta_ins_bt_a16_0.COL9 AS COL9, delta_ins_bt_a16_0.COL10 AS COL10, delta_ins_bt_a16_0.COL11 AS COL11, delta_ins_bt_a16_0.COL12 AS COL12, delta_ins_bt_a16_0.COL13 AS COL13, delta_ins_bt_a16_0.COL14 AS COL14, delta_ins_bt_a16_0.COL15 AS COL15 
FROM (SELECT p_0_a16_0.COL0 AS COL0, p_0_a16_0.COL1 AS COL1, p_0_a16_0.COL2 AS COL2, p_0_a16_0.COL3 AS COL3, p_0_a16_0.COL4 AS COL4, p_0_a16_0.COL5 AS COL5, p_0_a16_0.COL6 AS COL6, p_0_a16_0.COL7 AS COL7, p_0_a16_0.COL8 AS COL8, p_0_a16_0.COL9 AS COL9, p_0_a16_0.COL10 AS COL10, p_0_a16_0.COL11 AS COL11, p_0_a16_0.COL12 AS COL12, p_0_a16_0.COL13 AS COL13, p_0_a16_0.COL14 AS COL14, p_0_a16_0.COL15 AS COL15 
...
FROM public.bt AS bt_a16 
WHERE bt_a16.V = __tmp_delta_ins_dnum_ar_a16_0.V AND bt_a16.L = __tmp_delta_ins_dnum_ar_a16_0.L AND bt_a16.D = __tmp_delta_ins_dnum_ar_a16_0.D AND bt_a16.R = __tmp_delta_ins_dnum_ar_a16_0.R AND bt_a16.P = __tmp_delta_ins_dnum_ar_a16_0.P AND bt_a16.LINEAGE = __tmp_delta_ins_dnum_ar_a16_0.LINEAGE AND bt_a16.COND1 = __tmp_delta_ins_dnum_ar_a16_0.COND1 AND bt_a16.COND2 = __tmp_delta_ins_dnum_ar_a16_0.COND2 AND bt_a16.COND3 = __tmp_delta_ins_dnum_ar_a16_0.COND3 AND bt_a16.COND4 = __tmp_delta_ins_dnum_ar_a16_0.COND4 AND bt_a16.COND5 = __tmp_delta_ins_dnum_ar_a16_0.COND5 AND bt_a16.COND6 = __tmp_delta_ins_dnum_ar_a16_0.COND6 AND bt_a16.COND7 = __tmp_delta_ins_dnum_ar_a16_0.COND7 AND bt_a16.COND8 = __tmp_delta_ins_dnum_ar_a16_0.COND8 AND bt_a16.COND9 = __tmp_delta_ins_dnum_ar_a16_0.COND9 AND bt_a16.COND10 = __tmp_delta_ins_dnum_ar_a16_0.COND10 ) ) AS p_0_a16_0  ) AS delta_ins_bt_a16_0  ) AS delta_ins_bt_extra_alias) AS tbl; 


            IF array_delta_del_bt IS DISTINCT FROM NULL THEN 
                FOREACH temprec_delta_del_bt IN array array_delta_del_bt  LOOP 
                   DELETE FROM public.bt WHERE V =  temprec_delta_del_bt.V AND L =  temprec_delta_del_bt.L AND D =  temprec_delta_del_bt.D AND R =  temprec_delta_del_bt.R AND P =  temprec_delta_del_bt.P AND LINEAGE =  temprec_delta_del_bt.LINEAGE AND COND1 =  temprec_delta_del_bt.COND1 AND COND2 =  temprec_delta_del_bt.COND2 AND COND3 =  temprec_delta_del_bt.COND3 AND COND4 =  temprec_delta_del_bt.COND4 AND COND5 =  temprec_delta_del_bt.COND5 AND COND6 =  temprec_delta_del_bt.COND6 AND COND7 =  temprec_delta_del_bt.COND7 AND COND8 =  temprec_delta_del_bt.COND8 AND COND9 =  temprec_delta_del_bt.COND9 AND COND10 =  temprec_delta_del_bt.COND10;
                END LOOP;
            END IF;
