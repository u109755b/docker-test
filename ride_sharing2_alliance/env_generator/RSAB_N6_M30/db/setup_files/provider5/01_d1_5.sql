...
SELECT __dummy__.COL0 AS V, __dummy__.COL1 AS L, __dummy__.COL2 AS D, __dummy__.COL3 AS R, __dummy__.COL4 AS LINEAGE FROM (SELECT d1_5_a5_0.COL0 AS COL0, d1_5_a5_0.COL1 AS COL1, d1_5_a5_0.COL2 AS COL2, d1_5_a5_0.COL3 AS COL3, d1_5_a5_0.COL4 AS COL4 FROM (SELECT bt_a11_0.V AS COL0, bt_a11_0.L AS COL1, bt_a11_0.D AS COL2, bt_a11_0.R AS COL3, bt_a11_0.LINEAGE AS COL4 FROM public.bt AS bt_a11_0 WHERE bt_a11_0.AL1 = 'true'  ) AS d1_5_a5_0   ) AS __dummy__   ;
...
BEGIN
    ...
    IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'd1_5_delta_action_flag') THEN
        ...
        END IF;
        DELETE FROM __tmp_delta_del_bt_for_d1_5 WHERE ROW(V,L,D,R,AL3,AL6,AL2,AL1,AL5,AL4,LINEAGE)= NEW;
        INSERT INTO __tmp_delta_ins_bt_for_d1_5 SELECT (NEW).*;
        ELSIF TG_OP = 'UPDATE' THEN
        IF (SELECT count(*) FILTER (WHERE j.value = jsonb 'null') FROM  jsonb_each(to_jsonb(NEW)) j) > 0 THEN
            RAISE check_violation USING MESSAGE = 'Invalid update: null value is not accepted';
        END IF;
        DELETE FROM __tmp_delta_ins_bt_for_d1_5 WHERE ROW(V,L,D,R,AL3,AL6,AL2,AL1,AL5,AL4,LINEAGE) = OLD;
...
IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'bt_detect_update_on_d1_5_flag') THEN
    ...
    IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'd1_5_delta_action_flag') THEN
        ...
        SELECT array_agg(tbl) INTO detected_insertions FROM (SELECT __dummy__.COL0 AS V, __dummy__.COL1 AS L, __dummy__.COL2 AS D, __dummy__.COL3 AS R, __dummy__.COL4 AS LINEAGE FROM (SELECT part_ins_d1_5_a5_0.COL0 AS COL0, part_ins_d1_5_a5_0.COL1 AS COL1, part_ins_d1_5_a5_0.COL2 AS COL2, part_ins_d1_5_a5_0.COL3 AS COL3, part_ins_d1_5_a5_0.COL4 AS COL4 FROM (SELECT p_0_a5_0.COL0 AS COL0, p_0_a5_0.COL1 AS COL1, p_0_a5_0.COL2 AS COL2, p_0_a5_0.COL3 AS COL3, p_0_a5_0.COL4 AS COL4 FROM (SELECT __tmp_delta_ins_bt_for_d1_5_ar_a11_0.V AS COL0, __tmp_delta_ins_bt_for_d1_5_ar_a11_0.L AS COL1, __tmp_delta_ins_bt_for_d1_5_ar_a11_0.D AS COL2, __tmp_delta_ins_bt_for_d1_5_ar_a11_0.R AS COL3, __tmp_delta_ins_bt_for_d1_5_ar_a11_0.LINEAGE AS COL4 FROM __tmp_delta_ins_bt_for_d1_5_ar AS __tmp_delta_ins_bt_for_d1_5_ar_a11_0 WHERE __tmp_delta_ins_bt_for_d1_5_ar_a11_0.AL1 = 'true' AND NOT EXISTS ( SELECT * FROM (SELECT __tmp_delta_ins_bt_for_d1_5_ar_a11_1.D AS COL0, __tmp_delta_ins_bt_for_d1_5_ar_a11_1.L AS COL1, __tmp_delta_ins_bt_for_d1_5_ar_a11_1.LINEAGE AS COL2, __tmp_delta_ins_bt_for_d1_5_ar_a11_1.R AS COL3, __tmp_delta_ins_bt_for_d1_5_ar_a11_1.V AS COL4 FROM __tmp_delta_del_bt_for_d1_5_ar AS __tmp_delta_del_bt_for_d1_5_ar_a11_0, __tmp_delta_ins_bt_for_d1_5_ar AS __tmp_delta_ins_bt_for_d1_5_ar_a11_1 WHERE __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL6 = __tmp_delta_del_bt_for_d1_5_ar_a11_0.AL6 AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.L = __tmp_delta_del_bt_for_d1_5_ar_a11_0.L AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.R = __tmp_delta_del_bt_for_d1_5_ar_a11_0.R AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL4 = __tmp_delta_del_bt_for_d1_5_ar_a11_0.AL4 AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.V = __tmp_delta_del_bt_for_d1_5_ar_a11_0.V AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.D = __tmp_delta_del_bt_for_d1_5_ar_a11_0.D AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.LINEAGE = __tmp_delta_del_bt_for_d1_5_ar_a11_0.LINEAGE AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL1 = __tmp_delta_del_bt_for_d1_5_ar_a11_0.AL1 AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL3 = __tmp_delta_del_bt_for_d1_5_ar_a11_0.AL3 AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL2 = __tmp_delta_del_bt_for_d1_5_ar_a11_0.AL2 AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL5 = __tmp_delta_del_bt_for_d1_5_ar_a11_0.AL5 AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL1 = 'true' AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL1 = 'true'   UNION SELECT __tmp_delta_ins_bt_for_d1_5_ar_a11_1.D AS COL0, __tmp_delta_ins_bt_for_d1_5_ar_a11_1.L AS COL1, __tmp_delta_ins_bt_for_d1_5_ar_a11_1.LINEAGE AS COL2, __tmp_delta_ins_bt_for_d1_5_ar_a11_1.R AS COL3, __tmp_delta_ins_bt_for_d1_5_ar_a11_1.V AS COL4 FROM public.bt AS bt_a11_0, __tmp_delta_ins_bt_for_d1_5_ar AS __tmp_delta_ins_bt_for_d1_5_ar_a11_1 WHERE __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL6 = bt_a11_0.AL6 AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.L = bt_a11_0.L AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.R = bt_a11_0.R AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL4 = bt_a11_0.AL4 AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.V = bt_a11_0.V AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.D = bt_a11_0.D AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.LINEAGE = bt_a11_0.LINEAGE AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL1 = bt_a11_0.AL1 AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL3 = bt_a11_0.AL3 AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL2 = bt_a11_0.AL2 AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL5 = bt_a11_0.AL5 AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL1 = 'true' AND __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL1 = 'true' AND NOT EXISTS ( SELECT * FROM (SELECT __tmp_delta_ins_bt_for_d1_5_ar_a11_0.AL1 AS COL0, __tmp_delta_ins_bt_for_d1_5_ar_a11_0.D AS COL1, __tmp_delta_ins_bt_for_d1_5_ar_a11_0.AL4 AS COL2, __tmp_delta_ins_bt_for_d1_5_ar_a11_0.AL5 AS COL3, __tmp_delta_ins_bt_for_d1_5_ar_a11_0.AL2 AS COL4, __tmp_delta_ins_bt_for_d1_5_ar_a11_0.AL6 AS COL5, __tmp_delta_ins_bt_for_d1_5_ar_a11_0.AL3 AS COL6, __tmp_delta_ins_bt_for_d1_5_ar_a11_0.L AS COL7, __tmp_delta_ins_bt_for_d1_5_ar_a11_0.LINEAGE AS COL8, __tmp_delta_ins_bt_for_d1_5_ar_a11_0.R AS COL9, __tmp_delta_ins_bt_for_d1_5_ar_a11_0.V AS COL10 FROM __tmp_delta_ins_bt_for_d1_5_ar AS __tmp_delta_ins_bt_for_d1_5_ar_a11_0 WHERE __tmp_delta_ins_bt_for_d1_5_ar_a11_0.AL1 = 'true'  ) AS p_2_a11 WHERE p_2_a11.COL10 = __tmp_delta_ins_bt_for_d1_5_ar_a11_1.V AND p_2_a11.COL9 = __tmp_delta_ins_bt_for_d1_5_ar_a11_1.R AND p_2_a11.COL8 = __tmp_delta_ins_bt_for_d1_5_ar_a11_1.LINEAGE AND p_2_a11.COL7 = __tmp_delta_ins_bt_for_d1_5_ar_a11_1.L AND p_2_a11.COL6 = __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL3 AND p_2_a11.COL5 = __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL6 AND p_2_a11.COL4 = __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL2 AND p_2_a11.COL3 = __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL5 AND p_2_a11.COL2 = __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL4 AND p_2_a11.COL1 = __tmp_delta_ins_bt_for_d1_5_ar_a11_1.D AND p_2_a11.COL0 = __tmp_delta_ins_bt_for_d1_5_ar_a11_1.AL1 )  ) AS p_1_a5 WHERE p_1_a5.COL4 = __tmp_delta_ins_bt_for_d1_5_ar_a11_0.V AND p_1_a5.COL3 = __tmp_delta_ins_bt_for_d1_5_ar_a11_0.R AND p_1_a5.COL2 = __tmp_delta_ins_bt_for_d1_5_ar_a11_0.LINEAGE AND p_1_a5.COL1 = __tmp_delta_ins_bt_for_d1_5_ar_a11_0.L AND p_1_a5.COL0 = __tmp_delta_ins_bt_for_d1_5_ar_a11_0.D )  ) AS p_0_a5_0   ) AS part_ins_d1_5_a5_0   ) AS __dummy__   ) AS tbl;
        ...
        WITH __tmp_delta_ins_bt_for_d1_5_ar as (SELECT * FROM unnest(array_delta_ins) as array_delta_ins_alias limit delta_ins_size),
        __tmp_delta_del_bt_for_d1_5_ar as (SELECT * FROM unnest(array_delta_del) as array_delta_del_alias limit delta_del_size)
        SELECT array_agg(tbl) INTO detected_deletions FROM (SELECT __dummy__.COL0 AS V, __dummy__.COL1 AS L, __dummy__.COL2 AS D, __dummy__.COL3 AS R, __dummy__.COL4 AS LINEAGE FROM (SELECT part_del_d1_5_a5_0.COL0 AS COL0, part_del_d1_5_a5_0.COL1 AS COL1, part_del_d1_5_a5_0.COL2 AS COL2, part_del_d1_5_a5_0.COL3 AS COL3, part_del_d1_5_a5_0.COL4 AS COL4 FROM (SELECT p_0_a5_0.COL0 AS COL0, p_0_a5_0.COL1 AS COL1, p_0_a5_0.COL2 AS COL2, p_0_a5_0.COL3 AS COL3, p_0_a5_0.COL4 AS COL4 FROM (SELECT __tmp_delta_del_bt_for_d1_5_ar_a11_0.V AS COL0, __tmp_delta_del_bt_for_d1_5_ar_a11_0.L AS COL1, __tmp_delta_del_bt_for_d1_5_ar_a11_0.D AS COL2, __tmp_delta_del_bt_for_d1_5_ar_a11_0.R AS COL3, __tmp_delta_del_bt_for_d1_5_ar_a11_0.LINEAGE AS COL4 FROM __tmp_delta_del_bt_for_d1_5_ar AS __tmp_delta_del_bt_for_d1_5_ar_a11_0 WHERE __tmp_delta_del_bt_for_d1_5_ar_a11_0.AL1 = 'true' AND NOT EXISTS ( SELECT * FROM (SELECT bt_a11_0.D AS COL0, bt_a11_0.L AS COL1, bt_a11_0.LINEAGE AS COL2, bt_a11_0.R AS COL3, bt_a11_0.V AS COL4 FROM public.bt AS bt_a11_0 WHERE bt_a11_0.AL1 = 'true'  ) AS p_1_a5 WHERE p_1_a5.COL4 = __tmp_delta_del_bt_for_d1_5_ar_a11_0.V AND p_1_a5.COL3 = __tmp_delta_del_bt_for_d1_5_ar_a11_0.R AND p_1_a5.COL2 = __tmp_delta_del_bt_for_d1_5_ar_a11_0.LINEAGE AND p_1_a5.COL1 = __tmp_delta_del_bt_for_d1_5_ar_a11_0.L AND p_1_a5.COL0 = __tmp_delta_del_bt_for_d1_5_ar_a11_0.D )  ) AS p_0_a5_0   ) AS part_del_d1_5_a5_0   ) AS __dummy__   ) AS tbl;
  ...
  BEGIN
    IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'd1_5_delta_action_flag') THEN
        ...
        select count(*) INTO delta_del_size FROM __tmp_delta_del_d1_5;
            ...
            FROM (SELECT delta_ins_bt_a11_0.COL0 AS COL0, delta_ins_bt_a11_0.COL1 AS COL1, delta_ins_bt_a11_0.COL2 AS COL2, delta_ins_bt_a11_0.COL3 AS COL3, delta_ins_bt_a11_0.COL4 AS COL4, delta_ins_bt_a11_0.COL5 AS COL5, delta_ins_bt_a11_0.COL6 AS COL6, delta_ins_bt_a11_0.COL7 AS COL7, delta_ins_bt_a11_0.COL8 AS COL8, delta_ins_bt_a11_0.COL9 AS COL9, delta_ins_bt_a11_0.COL10 AS COL10 FROM (SELECT p_0_a11_0.COL0 AS COL0, p_0_a11_0.COL1 AS COL1, p_0_a11_0.COL2 AS COL2, p_0_a11_0.COL3 AS COL3, p_0_a11_0.COL4 AS COL4, p_0_a11_0.COL5 AS COL5, p_0_a11_0.COL6 AS COL6, p_0_a11_0.COL7 AS COL7, p_0_a11_0.COL8 AS COL8, p_0_a11_0.COL9 AS COL9, p_0_a11_0.COL10 AS COL10 FROM (SELECT __tmp_delta_ins_d1_5_ar_a5_0.V AS COL0, __tmp_delta_ins_d1_5_ar_a5_0.L AS COL1, __tmp_delta_ins_d1_5_ar_a5_0.D AS COL2, __tmp_delta_ins_d1_5_ar_a5_0.R AS COL3, 'false' AS COL4, 'false' AS COL5, 'false' AS COL6, 'true' AS COL7, 'false' AS COL8, 'false' AS COL9, __tmp_delta_ins_d1_5_ar_a5_0.LINEAGE AS COL10 FROM __tmp_delta_ins_d1_5_ar AS __tmp_delta_ins_d1_5_ar_a5_0 WHERE NOT EXISTS ( SELECT * FROM (SELECT bt_a11_1.V AS COL0, bt_a11_1.L AS COL1, bt_a11_1.LINEAGE AS COL2, bt_a11_1.D AS COL3, bt_a11_1.R AS COL4, bt_a11_0.AL3 AS COL5, bt_a11_0.AL6 AS COL6, bt_a11_0.AL2 AS COL7, 'true' AS COL8, bt_a11_0.AL5 AS COL9, bt_a11_0.AL4 AS COL10 FROM public.bt AS bt_a11_0, public.bt AS bt_a11_1 WHERE bt_a11_1.V = bt_a11_0.V AND bt_a11_1.AL1 = 'true' AND NOT EXISTS ( SELECT * FROM public.bt AS bt_a11 WHERE bt_a11.LINEAGE = bt_a11_1.LINEAGE AND bt_a11.R = bt_a11_1.R AND bt_a11.D = bt_a11_1.D AND bt_a11.L = bt_a11_1.L AND bt_a11.V = bt_a11_1.V )  ) AS p_1_a11 WHERE p_1_a11.COL10 = 'false' AND p_1_a11.COL9 = 'false' AND p_1_a11.COL8 = 'true' AND p_1_a11.COL7 = 'false' AND p_1_a11.COL6 = 'false' AND p_1_a11.COL5 = 'false' AND p_1_a11.COL4 = __tmp_delta_ins_d1_5_ar_a5_0.R AND p_1_a11.COL3 = __tmp_delta_ins_d1_5_ar_a5_0.D AND p_1_a11.COL2 = __tmp_delta_ins_d1_5_ar_a5_0.LINEAGE AND p_1_a11.COL1 = __tmp_delta_ins_d1_5_ar_a5_0.L AND p_1_a11.COL0 = __tmp_delta_ins_d1_5_ar_a5_0.V ) AND NOT EXISTS ( SELECT * FROM public.bt AS bt_a11 WHERE bt_a11.LINEAGE = __tmp_delta_ins_d1_5_ar_a5_0.LINEAGE AND bt_a11.R = __tmp_delta_ins_d1_5_ar_a5_0.R AND bt_a11.D = __tmp_delta_ins_d1_5_ar_a5_0.D AND bt_a11.L = __tmp_delta_ins_d1_5_ar_a5_0.L AND bt_a11.V = __tmp_delta_ins_d1_5_ar_a5_0.V ) AND NOT EXISTS ( SELECT * FROM public.bt AS bt_a11 WHERE bt_a11.V = __tmp_delta_ins_d1_5_ar_a5_0.V )   UNION SELECT bt_a11_1.V AS COL0, __tmp_delta_ins_d1_5_ar_a5_0.L AS COL1, __tmp_delta_ins_d1_5_ar_a5_0.D AS COL2, __tmp_delta_ins_d1_5_ar_a5_0.R AS COL3, bt_a11_1.AL3 AS COL4, bt_a11_1.AL6 AS COL5, bt_a11_1.AL2 AS COL6, 'true' AS COL7, bt_a11_1.AL5 AS COL8, bt_a11_1.AL4 AS COL9, __tmp_delta_ins_d1_5_ar_a5_0.LINEAGE AS COL10 FROM __tmp_delta_ins_d1_5_ar AS __tmp_delta_ins_d1_5_ar_a5_0, public.bt AS bt_a11_1 WHERE bt_a11_1.V = __tmp_delta_ins_d1_5_ar_a5_0.V AND NOT EXISTS ( SELECT * FROM (SELECT bt_a11_0.V AS COL0, bt_a11_0.L AS COL1, bt_a11_0.LINEAGE AS COL2, bt_a11_0.D AS COL3, bt_a11_0.R AS COL4, 'false' AS COL5, 'false' AS COL6, 'false' AS COL7, 'true' AS COL8, 'false' AS COL9, 'false' AS COL10 FROM public.bt AS bt_a11_0 WHERE bt_a11_0.AL1 = 'true' AND NOT EXISTS ( SELECT * FROM public.bt AS bt_a11 WHERE bt_a11.LINEAGE = bt_a11_0.LINEAGE AND bt_a11.R = bt_a11_0.R AND bt_a11.D = bt_a11_0.D AND bt_a11.L = bt_a11_0.L AND bt_a11.V = bt_a11_0.V ) AND NOT EXISTS ( SELECT * FROM public.bt AS bt_a11 WHERE bt_a11.V = bt_a11_0.V )  ) AS p_3_a11 WHERE p_3_a11.COL10 = bt_a11_1.AL4 AND p_3_a11.COL9 = bt_a11_1.AL5 AND p_3_a11.COL8 = 'true' AND p_3_a11.COL7 = bt_a11_1.AL2 AND p_3_a11.COL6 = bt_a11_1.AL6 AND p_3_a11.COL5 = bt_a11_1.AL3 AND p_3_a11.COL4 = __tmp_delta_ins_d1_5_ar_a5_0.R AND p_3_a11.COL3 = __tmp_delta_ins_d1_5_ar_a5_0.D AND p_3_a11.COL2 = __tmp_delta_ins_d1_5_ar_a5_0.LINEAGE AND p_3_a11.COL1 = __tmp_delta_ins_d1_5_ar_a5_0.L AND p_3_a11.COL0 = bt_a11_1.V ) AND NOT EXISTS ( SELECT * FROM (SELECT bt_a11_1.V AS COL0, bt_a11_1.L AS COL1, bt_a11_1.LINEAGE AS COL2, bt_a11_1.D AS COL3, bt_a11_1.R AS COL4, bt_a11_0.AL3 AS COL5, bt_a11_0.AL6 AS COL6, bt_a11_0.AL2 AS COL7, 'true' AS COL8, bt_a11_0.AL5 AS COL9, bt_a11_0.AL4 AS COL10 FROM public.bt AS bt_a11_0, public.bt AS bt_a11_1 WHERE bt_a11_1.V = bt_a11_0.V AND bt_a11_1.AL1 = 'true' AND NOT EXISTS ( SELECT * FROM public.bt AS bt_a11 WHERE bt_a11.LINEAGE = bt_a11_1.LINEAGE AND bt_a11.R = bt_a11_1.R AND bt_a11.D = bt_a11_1.D AND bt_a11.L = bt_a11_1.L AND bt_a11.V = bt_a11_1.V )  ) AS p_2_a11 WHERE p_2_a11.COL10 = bt_a11_1.AL4 AND p_2_a11.COL9 = bt_a11_1.AL5 AND p_2_a11.COL8 = 'true' AND p_2_a11.COL7 = bt_a11_1.AL2 AND p_2_a11.COL6 = bt_a11_1.AL6 AND p_2_a11.COL5 = bt_a11_1.AL3 AND p_2_a11.COL4 = __tmp_delta_ins_d1_5_ar_a5_0.R AND p_2_a11.COL3 = __tmp_delta_ins_d1_5_ar_a5_0.D AND p_2_a11.COL2 = __tmp_delta_ins_d1_5_ar_a5_0.LINEAGE AND p_2_a11.COL1 = __tmp_delta_ins_d1_5_ar_a5_0.L AND p_2_a11.COL0 = bt_a11_1.V ) AND NOT EXISTS ( SELECT * FROM public.bt AS bt_a11 WHERE bt_a11.LINEAGE = __tmp_delta_ins_d1_5_ar_a5_0.LINEAGE AND bt_a11.R = __tmp_delta_ins_d1_5_ar_a5_0.R AND bt_a11.D = __tmp_delta_ins_d1_5_ar_a5_0.D AND bt_a11.L = __tmp_delta_ins_d1_5_ar_a5_0.L AND bt_a11.V = bt_a11_1.V )  ) AS p_0_a11_0   ) AS delta_ins_bt_a11_0   ) AS delta_ins_bt_extra_alias) AS tbl; 
