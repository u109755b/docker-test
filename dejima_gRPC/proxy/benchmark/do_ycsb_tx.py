...
from benchmark.ycsb_tx import YCSBTx
import json
import time
...
@tracer.start_as_current_span("do_ycsb_tx")
def doYCSB(params, locking_method):
    ...
    local_locks_result = ycsb_tx.get_local_locks()
    ...
    local_tx_result = ycsb_tx.execute_local_tx()
