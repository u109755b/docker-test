...
from benchmark.tpcc_pay_tx import TPCCPayTx
import json
import time
...
def doTPCC_PAY(params, locking_method):
    ...
    tpcc_pay_tx = TPCCPayTx(tx, {'global_xid': global_xid})


    # get local locks, check whether miss or not, and get lineages
    local_locks_result = tpcc_pay_tx.get_local_locks()
    ...
    local_tx_result = tpcc_pay_tx.execute_local_tx()
