...
while True:
    try: 
        pool = CustomedThreadedConnectionPool(max_txn_cnt=5, minconn=10, maxconn=1005, host="{}-db".format(config.peer_name), port="5432", dbname="postgres", user="dejima", password="barfoo")
        break
