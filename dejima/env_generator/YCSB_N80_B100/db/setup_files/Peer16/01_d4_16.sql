...
WHERE bt_a22_0.COND9  <  100 ) AS d4_16_a22_0  ) AS __dummy__;
...
BEGIN
    ...
    THEN
        ...
        CREATE TEMPORARY TABLE IF NOT EXISTS __tmp_delta_ins_bt_for_d4_16 ( LIKE public.bt ) WITH OIDS ON COMMIT DELETE ROWS;
        CREATE TEMPORARY TABLE IF NOT EXISTS __tmp_delta_del_bt_for_d4_16 ( LIKE public.bt ) WITH OIDS ON COMMIT DELETE ROWS;
...
WHERE __tmp_delta_ins_bt_for_d4_16_ar_a22_0.COND9  <  100 ) AS p_0_a22_0  ) AS part_ins_d4_16_a22_0  ) AS __dummy__) AS tbl;
...
WHERE __tmp_delta_del_bt_for_d4_16_ar_a22_0.COND9  <  100 ) AS p_0_a22_0  ) AS part_del_d4_16_a22_0  ) AS __dummy__) AS tbl;
...
WHERE __tmp_delta_ins_d4_16_ar_a22_0.COND9  <  100 AND NOT EXISTS ( SELECT * 
...
CREATE CONSTRAINT TRIGGER __zzz_clean_d4_16
    AFTER INSERT OR UPDATE OR DELETE ON
    public.bt DEFERRABLE INITIALLY DEFERRED FOR EACH ROW EXECUTE PROCEDURE public.clean_dummy_d4_16();
